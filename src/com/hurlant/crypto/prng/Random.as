   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         while(this.var_109 < this.psize)
         {
            ...
            var _loc4_:*;
            this.var_150[_loc4_ = this.var_109++] = _loc2_ & 255;
         }
         this.var_109 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc4_:*;
         this.var_150[_loc4_ = this.var_109++] = this.var_150[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_150[_loc5_ = this.var_109++] = this.var_150[_loc5_] ^ param1 >> 24 & 255;
