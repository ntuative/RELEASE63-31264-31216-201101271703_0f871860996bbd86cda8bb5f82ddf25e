package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_965:String = "AssetLibraryReady";
      
      public static const const_739:String = "AssetLibraryLoaded";
      
      public static const const_1627:String = "AssetLibraryUnloaded";
      
      public static const const_1429:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_438 = new Dictionary(false);
      ...
      {
         if(this._file == param1.url && this.var_797)
         {
            if(!this.var_795 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_644,this.var_529);
            }
            this.var_795 = param2;
            dispatchEvent(new Event(AssetLibrary.const_965));
         }
         else
         {
      ...
      {
         var _loc2_:Class = this.var_798[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_438[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1029,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_998,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1133,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1112,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_438[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_438[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_372;
                     this.var_370.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_438[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_370.length ? this.getAssetByName(this.var_370[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_137)
         {
            ...
            {
               return this.var_370.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_137[param1] != null || (this.var_529 != null ? this.var_529[param1] != null : false);
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_797 = true;
         dispatchEvent(new Event(AssetLibrary.const_739));
         dispatchEvent(new Event(AssetLibrary.const_965));
         if(this.var_795)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1429));
         this.var_39 = null;
      }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_529[param1]);
