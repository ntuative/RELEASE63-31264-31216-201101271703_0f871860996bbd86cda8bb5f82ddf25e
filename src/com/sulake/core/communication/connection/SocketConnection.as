package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_435:ByteArray;
      
      private var var_977:IEncryption;
      
      private var var_643:IProtocol;
      ...
      private var var_436:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_302 = param2;
         this.var_435 = new ByteArray();
         this.var_976 = new MessageClassManager();
         this.var_73 = new Socket();
         this.var_309 = new Timer(const_1616,1);
         this.var_309.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_436)
         {
            this.var_436.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_309.start();
         this.var_642 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = this.var_643.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_436)
         {
            this.var_436.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_977 != null)
         {
            _loc3_ = this.var_977.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_643.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_643.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_977 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_643.getMessages(this.var_435,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_436)
               {
                  this.var_436.messageReceived(String(id),data.toString());
               }
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_435,offset);
               this.var_435 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_435.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_435.writeByte(this.var_73.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_309.stop();
         this.var_1479 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_642));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1479 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_642));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_642));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_642));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_642));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_642));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_309.delay + " ms). Possible Firewall.";
