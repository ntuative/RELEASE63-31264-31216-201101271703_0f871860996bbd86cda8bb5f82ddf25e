package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_592:Map = new Map();
      
      private static const const_326:Map = new Map();
      
      private static var var_1190:Boolean = false;
      ...
      {
         return const_592.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1190)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_592.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1190 = true;
         }
