package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_925:uint = 8;
      
      private static const const_1304:String = "skin";
      
      private static const const_1306:String = "bitmap";
      
      private static const const_1307:String = "fill";
      
      private static const const_1305:String = "text";
      
      private static const const_1302:String = "label";
      
      private static const const_1303:String = "shape";
      ...
      private var var_2525:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2527 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1776,this.var_2527);
         this.var_2525 = new Dictionary();
         this.var_2526 = new Dictionary();
         StateCodeTable.fillTables(this.var_2525,this.var_2526);
         this.var_408 = new Dictionary();
         this.var_408[const_1304] = BitmapSkinRenderer;
         this.var_408[const_1306] = BitmapDataRenderer;
         this.var_408[const_1307] = FillSkinRenderer;
         this.var_408[const_1305] = TextSkinRenderer;
         this.var_408[const_1302] = LabelRenderer;
         this.var_408[const_1303] = ShapeSkinRenderer;
         this.var_408[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_408[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_306 == null)
         {
            var_306 = new Array();
            var_306.push(WindowState.const_67);
            var_306.push(WindowState.const_75);
            var_306.push(WindowState.const_87);
            var_306.push(WindowState.const_49);
            var_306.push(WindowState.const_88);
            var_306.push(WindowState.const_78);
            var_306.push(WindowState.const_103);
            var_306.push(WindowState.const_98);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2702 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "AssetLoaderEventBroker" : false;
                  ...
                  this.addSkinRenderer(this.var_1776[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_913[param1] == null)
         {
            this.var_913[param1] = new Array(const_925);
         }
         this.var_913[param1][param2] = param3;
         if(this.var_914[param1] == null)
         {
            this.var_914[param1] = new Array(const_925);
         }
         this.var_914[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_913[param1];
         if(_loc3_)
         {
