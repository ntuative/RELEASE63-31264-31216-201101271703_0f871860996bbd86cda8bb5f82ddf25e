package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_365:Dictionary;
      
      protected var _templatesByState:Dictionary;
      
      protected var var_524:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               ISkinLayout(this.var_524[_loc1_]).dispose();
               delete this.var_524[_loc1_];
            }
            this.var_524 = null;
            this.var_430 = null;
            for(_loc1_ in this.var_365)
            {
               ISkinTemplate(this.var_365[_loc1_]).dispose();
               delete this.var_365[_loc1_];
            }
            this.var_365 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_365[param2];
         if(_loc3_ == null)
         {
      ...
      {
         this.var_524[param1.name] = param1;
         return param1;
      }
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_365[param1.name];
         if(param1 != null)
         {
            for(_loc2_ in this.var_430)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(this.var_430[_loc3_] == param1)
               {
                  this.removeLayoutFromRenderState(_loc3_);
               }
            }
            delete this.var_524[param1.name];
         }
         return param1;
      }
      ...
      {
         this.var_365[param1.name] = param1;
         return param1;
      }
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_365[param1.name];
         }
         return param1;
      }
   }
