package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1224:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1225:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_938 = param3;
         var _loc4_:ByteArray = new var_1224() as ByteArray;
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_807)
            {
               this.var_1477 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      public function refresh(param1:Event) : void
      {
         ...
         if(this.var_1477)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_136.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_136.numBitmapAssetInstances + " / " + this.var_136.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_938.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_136.numTrackedBitmapDataInstances + " / " + this.var_136.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1225() as ByteArray;
