package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_972:ITabSelectorWindow;
      
      protected var var_1967:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_972 = findChildByTag(const_1312) as ITabSelectorWindow;
            if(this.var_972 != null)
            {
               this.var_972.procedure = this.selectorEventProc;
            }
         }
         return this.var_972;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1967 = findChildByTag(const_1311) as IWindowContainer;
         }
      ...
      {
         return !!this.var_714 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_972.numSelectables;
      }
