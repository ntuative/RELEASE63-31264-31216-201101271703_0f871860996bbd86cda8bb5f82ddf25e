package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1219 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_966,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_496)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_714 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_15.handleError(WindowContext.const_377,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_829,false,PropertyStruct.const_35,true) : PropertyDefaults.const_1528);
         _loc1_.push(this.var_1204 != PropertyDefaults.const_1119 ? new PropertyStruct(PropertyDefaults.const_784,this.var_1204,PropertyStruct.const_35,true) : PropertyDefaults.const_1432);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1091 ? new PropertyStruct(PropertyDefaults.const_873,_field.selectable,PropertyStruct.const_35,true) : PropertyDefaults.const_1496);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_999 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_35,true) : PropertyDefaults.const_1433);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_784:
                  this.var_1204 = _loc2_.value as Boolean;
                  if(this.var_1204)
                  {
               ...
               case PropertyDefaults.const_829:
                  ...
                  break;
               case PropertyDefaults.const_1071:
