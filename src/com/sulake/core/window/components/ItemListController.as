package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1959:Boolean = false;
      
      protected var var_522:Boolean = false;
      ...
      protected var var_2764:Number = 0.0;
      
      protected var var_969:Boolean = true;
      
      protected var var_429:Boolean = false;
      
      protected var var_1213:Boolean = false;
      
      protected var var_1961:int = 0;
      
      protected var var_1960:int = 0;
      
      protected var var_1212:Number;
      
      protected var var_1211:Number;
      
      protected var var_1210:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_102 = 0;
         this.var_91 = 0;
         this._horizontal = param2 == WindowType.const_361;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_159 = var_432 || !testParamFlag(WindowParam.const_32);
         this._container = var_15.create("_CONTAINER","",WindowType.const_391,WindowStyle.const_785,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_45,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_544,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_274,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_480,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1213;
      }
      ...
      {
         return new Rectangle(this.var_638 * this.maxScrollH,this.var_639 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_638)
         {
            this.var_638 = param1;
            this._container.x = -this.var_638 * this.maxScrollH;
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_639 = param1;
            this._container.y = -this.var_639 * this.maxScrollV;
            var_15.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_63);
            dispatchEvent(new WindowEvent(WindowEvent.const_530,this,null));
         }
      }
      ...
      {
         this.var_2764 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_456,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_544,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_274,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_480,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_41:
               this.var_1961 = _loc3_;
               this.var_1960 = _loc4_;
               this.var_1212 = 0;
               this.var_1211 = 0;
               this.var_1210 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_177:
               if(this.var_1210)
               {
                  this.var_1212 = this.var_1961 - _loc3_;
                  this.var_1211 = this.var_1960 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1212 != 0 && this.var_102 != 0)
                     {
                        this.scrollH += this.var_1212 / this.var_102;
                     }
                  }
                  else if(this.var_1211 != 0 && this.var_91 != 0)
                  {
                     this.scrollV += this.var_1211 / this.var_91;
                  }
                  this.var_1961 = _loc3_;
                  this.var_1960 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_185:
               if(this.var_1210)
               {
                  if(this._horizontal)
                  {
                     var_15.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1212,0);
                  }
                  else
                  {
                     var_15.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1211);
                  }
                  this.var_1210 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_969 && !this.var_522 && this._container)
         {
            this.var_522 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_856)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_362,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_955);
         }
         if(this.var_969 != PropertyDefaults.const_1153)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_767,this.var_969,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1537);
         }
         if(this.var_429 != PropertyDefaults.const_1038)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_700,this.var_429,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1523);
         }
         if(this.var_1213 != PropertyDefaults.const_949)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_699,this.var_1213,PropertyStruct.const_35,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1438);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_362:
               ...
               case PropertyDefaults.const_699:
                  ...
                  break;
               case PropertyDefaults.const_767:
                  this.var_969 = _loc2_.value as Boolean;
                  break;
            }
         }
