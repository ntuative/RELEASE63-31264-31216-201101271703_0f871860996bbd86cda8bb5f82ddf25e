package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1213:String = "_TITLE";
      
      private static const const_1214:String = "_HEADER";
      ...
      private var var_1274:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1213) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1274 = findChildByTag(const_1214) as IHeaderWindow;
            if(!this.var_1274)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_162 = findChildByTag(const_1212) as IWindowContainer;
            if(!this.var_162)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1195,_loc2_,false);
      ...
      {
         return this.content != null && this.var_971 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_311,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_238,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_231,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
