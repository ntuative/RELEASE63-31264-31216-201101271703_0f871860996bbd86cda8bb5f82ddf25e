package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_317:Object = null;
      ...
      {
         return this.var_317 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_394);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_317 != null)
            {
               _loc1_.textColor = uint(this.var_317);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_394 != param1.name)
         {
            this.var_394 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2085 = _loc2_.textWidth;
         this.var_2086 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_317 != _loc2_.color : this.var_317 != null && this.var_317 != PropertyDefaults.const_608) ? new PropertyStruct(PropertyDefaults.const_373,this.var_317,PropertyStruct.const_132,true) : PropertyDefaults.const_1084);
         if(this.var_37)
         {
            if(this.var_37.left != PropertyDefaults.const_602)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,this.var_37.left,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_474);
            }
            if(this.var_37.top != PropertyDefaults.const_816)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_238,this.var_37.top,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_551);
            }
            if(this.var_37.right != PropertyDefaults.const_863)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,this.var_37.right,PropertyStruct.const_38,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_561);
            }
            if(this.var_37.bottom != PropertyDefaults.const_693)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_231,this.var_37.bottom,PropertyStruct.const_38,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_373:
                  this.var_317 = _loc2_.value as uint;
                  break;
