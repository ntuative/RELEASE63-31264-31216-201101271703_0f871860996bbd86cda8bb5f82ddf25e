package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1253:String = "increment";
      
      private static const const_1252:String = "decrement";
      
      private static const const_907:String = "slider_track";
      ...
      protected var var_637:Number = 0.1;
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_873 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_907) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_315)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_637;
                  }
                  else
                  {
                     this.scrollV -= this.var_637;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_496)
         {
            ...
            else if(param2.name == const_1252)
            {
               if(this.var_18)
               {
                  this.var_1091 = true;
         ...
         if(param1.type == WindowMouseEvent.const_315)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_873) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_873) as IScrollableWindow;
               if(_loc1_)
               {
