package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_957:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1898:StyleSheet = null;
      ...
      {
         this.var_776 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1194 == param2)
         {
            return;
         }
         param1.var_1194 = param2;
         param1.var_1898 = null;
         if(param1.var_1194 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1194);
            param1.var_1898 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_761.indexOf(param1) > -1)
         {
            this.var_776 = param1;
         }
      }
      ...
      {
         return this.var_776 == LinkTarget.const_31 ? defaultLinkTarget : this.var_776;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1898;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_776 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_676,this.var_776,PropertyStruct.const_52,true,PropertyDefaults.const_761));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1584);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_676)
            {
               this.var_776 = _loc2_.value as String;
               break;
            }
