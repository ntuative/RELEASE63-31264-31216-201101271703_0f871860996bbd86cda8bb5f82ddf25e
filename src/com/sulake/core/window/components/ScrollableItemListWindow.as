package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1180:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_417)
         {
            this.var_417.removeEventListener(WindowEvent.const_318,this.scrollBarEventProc);
            this.var_417.removeEventListener(WindowEvent.const_252,this.scrollBarEventProc);
            this.var_417 = null;
         }
         if(this.var_1180)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1180)
         {
            this.var_1180 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_417)
         {
            ...
            if(this.var_417)
            {
               this.var_417.addEventListener(WindowEvent.const_318,this.scrollBarEventProc);
               this.var_417.addEventListener(WindowEvent.const_252,this.scrollBarEventProc);
            }
         }
         return this.var_417;
      }
