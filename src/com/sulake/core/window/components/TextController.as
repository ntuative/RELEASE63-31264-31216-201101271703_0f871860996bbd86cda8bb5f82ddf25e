package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1196:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_787:Number;
      ...
      private var var_394:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_394,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_394 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_394,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      {
         return TextStyleManager.getStyle(this.var_394);
      }
      ...
      {
         this.var_787 = param1;
         this._field.scrollH = this.var_787 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_787 * this.maxScrollH,this.var_521 * this.maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_520)
         {
            if(param2.type == WindowNotifyEvent.const_176)
            {
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_394);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1134) ? new PropertyStruct(PropertyDefaults.const_672,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1191) : PropertyDefaults.const_1414);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1185 ? new PropertyStruct(PropertyDefaults.const_806,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1132) : PropertyDefaults.const_1378);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_262,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1154 ? new PropertyStruct(PropertyDefaults.const_972,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_959) : PropertyDefaults.const_1453);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_608) ? new PropertyStruct(PropertyDefaults.const_373,this._field.textColor,PropertyStruct.const_132,true) : PropertyDefaults.const_1084);
         _loc1_.push(this.var_394 != TextStyleManager.const_195 ? new PropertyStruct(PropertyDefaults.const_386,this.var_394,PropertyStruct.const_52,true,PropertyDefaults.const_845) : PropertyDefaults.const_1020);
         _loc1_.push(this.var_37.left != PropertyDefaults.const_602 ? new PropertyStruct(PropertyDefaults.const_236,this.var_37.left,PropertyStruct.const_38,true) : PropertyDefaults.const_474);
         _loc1_.push(this.var_37.top != PropertyDefaults.const_816 ? new PropertyStruct(PropertyDefaults.const_238,this.var_37.top,PropertyStruct.const_38,true) : PropertyDefaults.const_551);
         _loc1_.push(this.var_37.right != PropertyDefaults.const_863 ? new PropertyStruct(PropertyDefaults.const_247,this.var_37.right,PropertyStruct.const_38,true) : PropertyDefaults.const_561);
         _loc1_.push(this.var_37.bottom != PropertyDefaults.const_693 ? new PropertyStruct(PropertyDefaults.const_231,this.var_37.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_560);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_997 ? new PropertyStruct(PropertyDefaults.const_733,this._field.mouseWheelEnabled,PropertyStruct.const_35,true) : PropertyDefaults.const_1397);
