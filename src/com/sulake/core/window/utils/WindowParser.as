package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_975:String = "_EXCLUDE";
      
      public static const const_1919:String = "_INCLUDE";
      
      public static const const_1874:String = "_TEMP";
      
      private static const const_1239:String = "layout";
      
      private static const const_904:String = "window";
      
      private static const const_906:String = "variables";
      
      private static const const_905:String = "filters";
      
      private static const const_575:String = "name";
      
      private static const const_1243:String = "style";
      
      private static const const_576:String = "params";
      
      private static const const_1249:String = "tags";
      ...
      private static const const_1240:String = "visible";
      
      private static const const_1246:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1141:String = "blend";
      
      private static const const_1241:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1237:String = "treshold";
      
      private static const const_1242:String = "children";
      
      private static const const_1247:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1235:String = "height_min";
      
      private static const const_1245:String = "height_max";
      
      private static const const_574:String = "AssetLoaderEventBroker";
      
      private static const const_158:String = "0";
      
      private static const const_1250:String = "$";
      ...
      private static const const_1244:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1467:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1206,this.var_1207);
         this.var_965 = new Dictionary();
         this.var_1467 = new Dictionary();
         ParamCodeTable.fillTables(this.var_965,this.var_1467);
         this.var_1958 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1244,const_48);
         return param1.replace(const_1236,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1206)
            {
               delete this.var_1206[_loc1_];
            }
            for(_loc1_ in this.var_1207)
            {
               delete this.var_1207[_loc1_];
            }
            for(_loc1_ in this.var_965)
            {
               delete this.var_965[_loc1_];
            }
            for(_loc1_ in this.var_1467)
            {
               delete this.var_1467[_loc1_];
            }
            this.var_1958.dispose();
            this.var_1958 = null;
            this.var_15 = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1239)
         {
            _loc8_ = param1.child(const_906);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_905).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1206[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_575,variables,"")));
         style = uint(this.parseAttribute(xml,const_1243,variables,style));
         params = uint(this.parseAttribute(xml,const_576,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1249,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_158));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_158));
         rect.width = Number(this.parseAttribute(xml,const_1251,variables,const_158));
         rect.height = Number(this.parseAttribute(xml,const_1238,variables,const_158));
         visible = this.parseAttribute(xml,const_1240,variables,visible.toString()) == const_574;
         caption = unescape(String(this.parseAttribute(xml,const_1246,variables,caption)));
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_576).length() > 0)
         {
            list = xml.child(const_576).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_575,variables,"") as String;
               if(this.var_965[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_575)) + "\"!");
               }
               params |= this.var_965[param];
               i++;
            }
         }
         if(tag != const_48)
         {
            tags = tag.split(const_1248);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this.var_15.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_906)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1247,variables,window.limits.minWidth));
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1245,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_574;
         blend = Number(this.parseAttribute(xml,const_1141,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1241,variables,window.clipping.toString()) == const_574;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1237,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_905).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc3_:String = this.var_1207[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_975) == -1)
                  {
