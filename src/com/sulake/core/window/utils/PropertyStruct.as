package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2762 = param3 == const_219 || param3 == const_130 || param3 == const_264 || param3 == const_215;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_35:
               return Boolean(this.var_178) == true ? "AssetLoaderEventBroker" : "false";
            case const_264:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_215:
               ...
               break;
            case const_132:
               _loc1_ = "<var key=\"" + this.var_632 + "\" value=\"" + "0x" + uint(this.var_178).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_632 + "\" value=\"" + this.var_178 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
