package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_79 = param1.var_1199 as WindowController;
         this._lastClickTarget = param1.var_1198 as WindowController;
         this.var_151 = param1.renderer;
         this.var_788 = param1.var_1197;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_640.x || _loc3_.stageY != this.var_640.y)
            {
               ...
               _loc6_ = new Array();
               this.var_132.groupParameterFilteredChildrenUnderPoint(this.var_640,_loc6_,WindowParam.const_28);
            }
         ...
         param1.var_1199 = this.var_79;
         param1.var_1198 = this._lastClickTarget;
         param1.renderer = this.var_151;
         param1.var_1197 = this.var_788;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_517))
         {
