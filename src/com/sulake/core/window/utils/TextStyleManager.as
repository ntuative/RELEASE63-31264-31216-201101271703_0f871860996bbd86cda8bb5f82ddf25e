package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_585:String = "{";
      
      private static const const_584:String = "}";
      
      private static const const_1310:String = "/*";
      
      private static const const_1309:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_84[const_195],var_84[ITALIC],var_84[BOLD]];
            var_84.reset();
            var_84[const_195] = _loc5_[0];
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "AssetLoaderEventBroker" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_585) != countSubStrings(param1,const_584))
         {
            throw new Error("Mismatching amount of \"" + const_585 + "\" versus \"" + const_584 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1310) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1309) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_585)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
