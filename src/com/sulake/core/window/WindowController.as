package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1089:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1195:String = "_COLORIZE";
      
      protected static const const_1634:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1325:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            ...
            var_58 = var_368.clone();
            var_11 = var_368.clone();
         ...
         if(_loc13_)
         {
            var_739 = _loc13_.blend;
            var_433 = _loc13_.var_2702;
            if(var_432 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_225 != _loc13_.color)
            {
      ...
      {
         return this.var_636 != null ? this.var_636 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_432 = param1;
         var_225 = !!var_432 ? uint(var_225 | var_525) : uint(var_225 & 16777215);
         this.var_159 = this.var_159 || param1;
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      ...
      {
         var_790 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_535,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_525 = param1 & 4278190080;
         var_225 = !!var_432 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      ...
      {
         var_525 = param1 << 24;
         var_225 = !!var_432 ? uint(var_525 | var_225) : uint(16777215 & var_225);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      
      public function set blend(param1:Number) : void
      {
         var_739 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_1141);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_415,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_411,this,this._parent));
            }
            else
            {
               this.var_342.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_958,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_731,var_11);
            this.var_21.visible = var_369;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_19,var_15,var_11,null,this.var_636,this.properties,var_791.concat(),_id) as WindowController;
         _loc2_.var_433 = var_433;
         _loc2_.var_159 = this.var_159;
         ...
         _loc2_.var_225 = var_225;
         _loc2_.var_525 = var_525;
         _loc2_.var_790 = var_790;
         _loc2_.var_369 = var_369;
         _loc2_.var_739 = var_739;
         _loc2_.var_19 = var_19;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_20;
         _loc2_.background = var_432;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2297 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1028,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_657,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_558,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_176,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  if(testParamFlag(WindowParam.const_354))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_315:
                  return false;
            }
         }
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_176:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_184,WindowParam.const_160))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_193,WindowParam.const_152))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_456))
                        {
               ...
               case WindowNotifyEvent.const_558:
                  var_15.invalidate(this,var_11.union(var_58),WindowRedrawFlag.const_549);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1189,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_387:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_747,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_249,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_415:
                  var_15.invalidate(this,var_11,WindowRedrawFlag.const_1049);
                  break;
               case WindowNotifyEvent.const_536:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1634) == -1)
                     {
                        _loc8_.style = var_80;
                     }
                  }
               ...
               case WindowNotifyEvent.const_535:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_15.invalidate(this,var_11,WindowRedrawFlag.const_549);
                     }
                  }
                  else if(var_19 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1039:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1419:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_535:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_747:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_249:
               _loc2_ = "null";
         ...
         if(this.var_159 && var_433 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1325,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1325,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_137,WindowParam.const_160);
         var _loc2_:* = !testParamFlag(WindowParam.const_147,WindowParam.const_152);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_367)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_526)
         {
            return true;
         }
         _state = WindowState.const_526;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1123,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1177,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1181,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1148,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_627;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_665;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1129,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1090 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1090 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_745,this,param1));
         return param1;
      }
