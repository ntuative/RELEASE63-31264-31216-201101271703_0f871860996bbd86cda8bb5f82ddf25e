package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1115:Number = 32;
      ...
      private var var_2750:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1689 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_175.x,this.var_175.y,this.var_175.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_75.x * this.var_396,this.var_75.y * this.var_397,this.var_75.z * this.var_395);
      }
      ...
      {
         if(this.var_396 != param1 * this.var_1690)
         {
            this.var_396 = param1 * this.var_1690;
            ++this.var_149;
         }
      }
      ...
      {
         if(this.var_397 != param1 * this.var_1688)
         {
            this.var_397 = param1 * this.var_1688;
            ++this.var_149;
         }
      }
      ...
      {
         if(this.var_395 != param1 * this.var_1689)
         {
            this.var_395 = param1 * this.var_1689;
            ++this.var_149;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_75.x /= this.var_396;
         this.var_75.y /= this.var_397;
         this.var_75.z /= this.var_395;
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_480 != null)
         {
            ...
            this.var_480.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_480.add(_loc3_,_loc4_);
            ++this.var_149;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_480 != null)
         {
            ...
            return this.var_480.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1093.assign(_loc22_);
         }
         else
         {
            this.var_1093.assign(_loc17_);
         }
         ++this.var_149;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1093);
         if(_loc3_ < this.var_2750 || _loc3_ > this.var_2749)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_397;
            _loc2_.z *= this.var_395;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1093);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_176,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_75.x * this.var_396,this.var_75.y * this.var_397,this.var_75.z * this.var_395);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_175;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_396,param2.y * this.var_397,param2.z * this.var_395);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_396,param3.y * this.var_397,param3.z * this.var_395);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_396,param4.y * this.var_397,param4.z * this.var_395);
