package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1438:int = 128;
      
      private var var_1437:Boolean = false;
      
      private var var_2759:Point;
      ...
      {
         if(param1 != this.var_1877 || param2 != this.var_1876)
         {
      ...
      {
         if(this.var_1438 > 255 || bitmapData == null)
         {
            return false;
         }
