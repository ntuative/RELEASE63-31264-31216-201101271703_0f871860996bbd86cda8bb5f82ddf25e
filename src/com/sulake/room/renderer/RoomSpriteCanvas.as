package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1648:int = 50;
      ...
      private var var_1267:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2098:Number = -1.0E7;
      
      private var var_2096:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_232.addChild(this.var_53);
      ...
      {
         this.var_450.x -= param1 - this.var_545;
         this.var_545 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_450.y -= param1 - this.var_547;
         this.var_547 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_856 = true;
            if(this.var_119 != null && !this.var_232.contains(this.var_119))
            {
               this.var_232.addChild(this.var_119);
               this.var_53.mask = this.var_119;
            }
         }
         else if(!param1 && this.var_856)
         {
            this.var_856 = false;
            if(this.var_119 != null && this.var_232.contains(this.var_119))
            {
               this.var_232.removeChild(this.var_119);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_546.length)
            {
               this.cleanSprite(this.var_546[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_546 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_660 != this.var_2097 || this._ht != this.var_2100)
         {
            _loc9_ = true;
         }
         if(this.var_53.x != this.var_545 || this.var_53.y != this.var_547)
         {
            this.var_53.x = this.var_545;
            this.var_53.y = this.var_547;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_451.sortOn("z",0 | 0);
         if(_loc5_ < this.var_451.length)
         {
            this.var_451.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_451[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2097 = this.var_660;
         this.var_2100 = this._ht;
      }
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_547;
                  if(_loc19_ < this.var_660 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_451.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_545;
                     _loc17_.y = _loc20_ - this.var_547;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_546.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_659 || this.var_659 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_451.length)
         {
            return null;
         }
         return this.var_451[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_545;
         param2 -= this.var_547;
         this.var_450.x = param1;
         this.var_450.y = param2;
         if(this.var_1013 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1551;
         }
         this.var_1551 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1013;
         return this.var_1551;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_660 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1550,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_548.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_548.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2098 || param2 != this.var_2096)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_548.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_548.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         ...
         {
            this.var_318.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_318 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_318.getKey(_loc1_);
            _loc3_ = this.var_318.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1267.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1013 == 0)
         {
            this.checkMouseHits(this.var_450.x,this.var_450.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1013 = 0;
         ++this.var_1550;
      }
