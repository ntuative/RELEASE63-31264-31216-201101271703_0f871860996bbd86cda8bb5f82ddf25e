package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_49:IRoomContentLoader;
      ...
      private var var_634:IRoomObjectFactory = null;
      
      private var var_517:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1195:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_633 = [];
         this.var_593 = [];
         events.addEventListener(RoomContentLoadedEvent.const_328,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_493,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_634 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_634 == null || this.var_517 == null)
         {
            return;
         }
         this._state = const_1567;
         if(this.var_1195 != null)
         {
            _loc1_ = this.var_1195;
            this.var_1195 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         this.var_986 = 50;
         this.var_158 = param2;
         var _loc3_:Array = this.var_49.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_];
            if(this.var_633.indexOf(_loc5_) < 0)
            {
               this.var_49.loadObjectContent(_loc5_,events);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_593.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_593[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!this.var_49.hasInternalContent(param3))
         {
            _loc7_ = this.var_49.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               this.var_49.loadObjectContent(param3,events);
               _loc12_ = this.var_49.getPlaceHolderType(param3);
               _loc7_ = this.var_49.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = this.var_49.getVisualizationXML(_loc12_);
            _loc9_ = this.var_49.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = this.var_49.getVisualizationType(_loc12_);
            _loc11_ = this.var_49.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_517.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_517.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_634.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_634 != null)
         {
            return this.var_634.createRoomObjectManager();
         }
         return null;
      }
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(this.var_49 != null)
         {
            if(this.var_49.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_758)
         {
            return;
         }
         if(this.var_49 == null)
         {
            this._state = const_758;
            return;
         }
         if(this.var_49.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_633.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_633.splice(_loc2_,1);
            }
            if(this.var_633.length == 0)
            {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc3_:XML = this.var_49.getVisualizationXML(_loc2_);
         if(_loc3_ == null)
         {
            if(this.var_158 != null)
            {
         ...
         var _loc4_:IGraphicAssetCollection = this.var_49.getGraphicAssetCollection(_loc2_);
         if(_loc4_ == null)
         {
            if(this.var_158 != null)
            {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_49 == null || this.var_517 == null)
         {
            return;
         }
         var _loc2_:XML = this.var_49.getVisualizationXML(param1);
         var _loc3_:XML = this.var_49.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = this.var_49.getGraphicAssetCollection(param1);
               ...
               while(_loc10_ >= 0)
               {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        _loc16_ = this.var_49.getContentType(_loc15_);
                        if(_loc16_ == param1)
                        {
                           _loc17_ = this.var_49.getVisualizationType(_loc15_);
                           _loc18_ = this.var_49.getLogicType(_loc15_);
                           _loc5_ = this.var_517.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_517.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_634.createRoomObjectLogic(_loc18_);
