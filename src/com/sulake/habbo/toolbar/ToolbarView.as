package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_205 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_56,HabboWindowStyle.const_1045,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1048 = String(_loc6_.relocate_by_drag.@state) == "AssetLoaderEventBroker";
         if(this.var_1048)
         {
         ...
         this.var_1049 = _loc6_.toolbar.@margin_top;
         this.var_1289 = _loc6_.toolbar.@margin_bottom;
         this.var_1621 = _loc6_.toolbar.@min_group_margin;
         this.var_1620 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_238,param1,param2,this._window,this.var_282);
         this.createGroupsFromXmlList(_loc8_,this.var_563,param1,param2,this.var_205,this.var_282);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_143,this.var_461,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_461);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_143,this.var_461);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_143,this.var_461);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_205.x = this.var_143 + this.var_1620;
               this.var_205.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_205.x = 0;
               this.var_205.y = this.var_143 + this.var_1620;
         ...
         _loc4_ -= this.var_1289;
         _loc4_ -= this.var_1049;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1049;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_238.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1621,(this._window.height - _loc5_ * _loc8_ - this.var_1049 - this.var_1289) / (this.var_238.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1621,(this._window.width - _loc5_ * _loc8_ - this.var_1049 - this.var_1289) / (this.var_238.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_238.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_461;
