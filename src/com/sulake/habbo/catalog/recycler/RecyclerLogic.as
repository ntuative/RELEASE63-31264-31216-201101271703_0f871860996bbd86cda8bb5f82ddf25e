package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_908:int = 0;
      ...
      {
         return this.var_573 != const_908;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1686 != RecyclerStatusMessageEvent.const_1067;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_573 == const_405;
      }
      ...
      {
         this.var_573 = const_909;
         this.var_108 = new Array(const_189);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1413:
               this.var_573 = const_405;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1067:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1559:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1023:
               if(this._view != null)
               {
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_108.length > 0)
         {
            oldObjectData = this.var_108[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_189)
            {
               oldObjectData = this.var_108[newSlotId];
         ...
         this.var_108[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_108[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_108[param1].id))
         {
            return;
         }
         this.var_108[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_108.length < const_189)
         {
            return false;
         }
         var _loc1_:int = 0;
