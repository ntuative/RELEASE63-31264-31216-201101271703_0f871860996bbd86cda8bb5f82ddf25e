package com.sulake.habbo.catalog.purchase
{
   ...
   public class ChargeConfirmationDialog implements IDisposable
   {
      ...
      private var var_768:ChargeInfo;
      ...
      public function refresh() : void
      {
         ...
         {
            this.showChargeInfo(this.var_768);
         }
      }
      ...
      public function showChargeInfo(param1:ChargeInfo) : void
      {
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.currentamount","charges","" + this.var_768.charges);
         var _loc2_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,new ChargeOffer(this.var_768));
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.info","patch_size","" + this.var_768.chargePatchSize);
      ...
      private function onCharge(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._catalog.connection.send(new UseFurnitureMessageComposer(this.var_768.stuffId,2));
      }
