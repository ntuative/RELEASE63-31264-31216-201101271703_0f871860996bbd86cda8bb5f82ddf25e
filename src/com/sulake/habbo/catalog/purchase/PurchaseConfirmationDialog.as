package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1658:uint = 4.293848814E9;
      
      private const const_1659:uint = 4.294967295E9;
      
      private const const_1951:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1643 = _loc1_.stuffTypes;
            this.var_697 = _loc1_.boxTypes;
            this.var_696 = _loc1_.ribbonTypes;
            this.var_1059 = this.var_1643[0];
            this.var_333 = this.var_697[0];
            this.var_331 = this.var_696[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_331 < 0)
         {
            this.var_331 = this.var_696.length - 1;
         }
         if(this.var_331 > this.var_696.length - 1)
         {
            this.var_331 = 0;
         }
         if(this.var_333 < 0)
         {
            this.var_333 = this.var_697.length - 1;
         }
         if(this.var_333 > this.var_697.length - 1)
         {
            this.var_333 = 0;
         }
         var _loc1_:int = this.var_697[this.var_333] * 1000 + this.var_696[this.var_331];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1059,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1294 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1643;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1059);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_697[this.var_333]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_696[this.var_331]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_90,this.var_1293,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_90.offerId,this.var_1293);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_112:
               ...
               for each(_loc7_ in this.var_200)
               {
                  ...
                  if(_loc5_.length >= this.const_1952)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2232 = _loc3_.text;
               break;
            ...
            case WindowKeyboardEvent.const_376:
               ...
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_332 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_332 + 1);
                     break;
      ...
      {
         if(this.var_240 == null || !this.var_240.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_240.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_332) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_240 == null)
         {
            this.var_240 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_566 == null)
         {
            this.var_566 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_566.procedure = this.suggestionsEventHandler;
         }
         if(this.var_240 == null || this.var_566 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_240.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_566.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_332) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_332);
         }
         this.var_332 = param1;
         if(this.var_332 < 0)
         {
            this.var_332 = _loc2_.numListItems - 1;
         }
         if(this.var_332 >= _loc2_.numListItems)
         {
            this.var_332 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_332) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1951;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1658) : uint(this.const_1659);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_240.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1059;
               }
            }
            _loc4_++;
         }
