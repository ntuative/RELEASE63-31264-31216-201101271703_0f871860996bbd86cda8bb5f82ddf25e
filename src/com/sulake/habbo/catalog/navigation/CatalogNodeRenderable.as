package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1208:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1254:XML;
      
      private static var var_1253:XML;
       
      
      private var var_1523:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1523 == 4294967295)
            {
               this.var_1523 = _loc1_.color;
            }
            _loc1_.color = const_1208;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1544;
            }
         }
      }
      ...
      {
         this.var_56 = navigator.catalog.windowManager.buildFromXML(var_1253) as IItemListWindow;
         if(this.var_56 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1254) as IWindowContainer;
         }
         else
         {
