package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1808:int = 1;
      
      public const const_1909:int = 2;
      
      public const const_1979:int = 3;
      ...
      private var var_2314:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2312,this.var_2311,this.var_2112,this.var_2313);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1808,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_436)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2310 = _loc3_.creditsWaiting;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1909,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      {
         if(param1.furniCategoryId != this.var_2057 || param1.furniTypeId != this.var_2053)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1230)
               {
                  _loc2_ = true;
               }
            }
