package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_567)
            {
               this.var_567 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_567).toString().length - 1);
         this.var_567 = Math.ceil(this.var_567 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_567.toString();
         _loc3_.draw(_loc6_);
         this.var_1063 = param1 - _loc6_.textWidth - 2;
         this.var_855 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_855);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_855 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_1063 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1063,(param2 - this.var_855) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1063 + this.var_1063 / -this.var_2744 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_855 - this.var_855 / this.var_567 * this.var_176[param1];
      }
