package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_600[this.var_1138][this.var_1766];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1138 = var_1203.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1138];
         var _loc3_:Array = this.var_600[this.var_1138] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1766 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1766] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_477 || _loc1_.pricingModel == Offer.const_489)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_81 || _loc3_.productType == ProductTypeEnum.const_83)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_600.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_600[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
