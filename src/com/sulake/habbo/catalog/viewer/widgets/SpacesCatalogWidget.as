package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1602:String = "default";
      ...
      private var var_1601:String = "1.1";
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1295[this.var_384];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1602);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1296[this.var_387];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1297[this.var_385];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1601);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_850[this.var_384];
         for each(_loc1_ in this.var_170.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_386 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_386];
                  if(_loc9_ != null)
                  {
                     this.var_1602 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         for each(_loc1_ in this.var_170.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_466];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1296[this.var_387];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_851[this.var_385];
         for each(_loc1_ in this.var_170.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_467];
               if(_loc13_ != null)
               {
                  this.var_1601 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1297[this.var_385];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_199:
               ...
               if(this.var_384 < 0)
               {
                  this.var_384 = this.var_850.length - 1;
               }
               if(this.var_384 == this.var_850.length)
               {
                  this.var_384 = 0;
               }
               this.var_386 = 0;
               this.var_853 = 0;
               _loc5_ = this.var_850[this.var_384];
               for each(_loc8_ in this.var_170.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_853 = _loc8_.children().length();
                  }
               }
            ...
            case const_97:
               ...
               if(this.var_385 < 0)
               {
                  this.var_385 = this.var_851.length - 1;
               }
               if(this.var_385 >= this.var_851.length)
               {
                  this.var_385 = 0;
               }
               this.var_467 = 0;
               this.var_854 = 0;
               _loc7_ = this.var_851[this.var_385];
               for each(_loc10_ in this.var_170.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_854 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1602,this.var_1601,64,this,"window_romantic_wide");
         ...
         {
            this.var_1646 = _loc2_.id;
            this.var_1647 = _loc3_.id;
