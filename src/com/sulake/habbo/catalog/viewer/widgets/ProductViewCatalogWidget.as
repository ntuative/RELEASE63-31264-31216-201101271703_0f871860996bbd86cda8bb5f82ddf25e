package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1088:ITextWindow;
      ...
      private var var_1324:IScrollbarWindow;
      
      protected var var_1862:XML;
      ...
      override public function init() : void
      {
         ...
         this.var_1088 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1676 = new Point(this.var_83.x,this.var_83.y);
         this.var_479 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1324 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_479 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1862 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         this.var_1675 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1088.text = _loc5_;
         this.var_872.height = this.var_872.textHeight + 5;
         this.var_1088.y = this.var_872.y + this.var_872.height;
         this.var_1088.height = Math.max(130,this.var_1088.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_472:
                  _loc6_ = this.var_1675.clone();
                  if(this.var_479 != null)
                  {
                     this.var_479.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_479,this.var_1324,this.var_1862);
                     this.var_479.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_221:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_303,AvatarAction.const_503);
                              _loc16_.appendAction(AvatarAction.const_292,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2296)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2296 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1676.x;
            this.var_83.y = this.var_1676.y;
            if(param3 != null)
            {
