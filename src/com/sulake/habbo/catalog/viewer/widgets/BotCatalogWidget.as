package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      private var var_712:Offer;
      
      protected var var_1203:IItemGridWindow;
      
      protected var var_1862:XML;
      
      private var var_1687:Map;
      
      private var var_346:IGridItem;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         this.var_1203 = _window.findChildByName("botGrid") as IItemGridWindow;
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_712,page.pageId);
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1862) as IWindowContainer;
         this.var_1203.addGridItem(_loc2_);
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1687.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1331.getValue(this.var_712.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_712.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_712.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_712.localizationId);
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1687.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            if(_loc3_.offerId == _loc2_ && _loc3_.productContainer && _loc3_.productContainer.view && !_loc3_.productContainer.view.disposed)
            {
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_712.offerId == _loc2_)
                  {
                     this.updatePreviewImage();
                  }
               }
