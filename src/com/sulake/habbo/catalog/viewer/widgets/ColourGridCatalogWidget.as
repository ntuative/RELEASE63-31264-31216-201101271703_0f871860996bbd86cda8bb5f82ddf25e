package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1890 = _loc1_.content as XML;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_870 = _loc4_.content as BitmapData;
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_346.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1444.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_346 = null;
         for each(_loc1_ in this.var_1444)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1890) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(this.var_775.width,this.var_775.height,true,0);
               _loc3_.bitmap.copyPixels(this.var_775,this.var_775.rect,new Point(0,0));
            }
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_870.width,this.var_870.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_870,this.var_870.rect,new Point(0,0),null,null,true);
