package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1139.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1140 != null)
         {
            this.var_1140.removeEventListener(WindowKeyboardEvent.const_150,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1139 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1139 != null)
         {
            this.var_1139.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1140 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1140 != null)
         {
            this.var_1140.addEventListener(WindowKeyboardEvent.const_150,this.windowKeyEventProcessor);
         }
      }
