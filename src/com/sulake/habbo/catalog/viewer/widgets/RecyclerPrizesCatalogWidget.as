package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1174:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1862:XML;
      
      private var var_1861:XML;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1174 = new PrizeViewer();
         this.var_765 = this.recycler.getPrizeTable();
         ...
         this.var_1861 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_765.length > 0 && this.var_765[0].prizes.length > 0)
         {
            this.select(this.var_765[0].prizes[0] as IGridItem);
         }
      }
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_765[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1861) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1862) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1174.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
