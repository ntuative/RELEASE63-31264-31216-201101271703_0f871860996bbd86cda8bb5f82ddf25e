package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      {
         super();
         this.var_1857 = param1.productType;
         this.var_1858 = param1.furniClassId;
         this.var_1425 = param1.extraParam;
         this.var_1426 = param1.productCount;
         this.var_1859 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_81:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1425);
               break;
