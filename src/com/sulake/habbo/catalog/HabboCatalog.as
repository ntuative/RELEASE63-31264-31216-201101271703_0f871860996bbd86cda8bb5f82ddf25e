package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_314:CatalogViewer;
      ...
      private var var_271:ChargeConfirmationDialog;
      ...
      private var var_2025:GiftWrappingConfiguration;
      
      private var var_985:ClubGiftController;
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_95.getActivityPointsForType(Purse.const_175)));
         var _loc1_:int = 0;
      ...
      {
         this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
            events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(this.var_88 != null && this.method_3() == "recycler")
            {
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_314 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_314.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1505 = param1.session.isPrivateRoom;
               if(this.var_88 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_985 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_649 && this.var_649 != "")
         {
            this.var_313.openPage(this.var_649);
            this.var_649 = "";
            this.var_808 = -1;
         }
         else if(this.var_808 > -1)
         {
            this.var_313.openPageById(this.var_808,this.var_1506);
            this.var_808 = -1;
            this.var_1506 = -1;
            this.var_649 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_314.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_314.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2024 && this.var_534 != null)
         {
            this.var_534.playSound(HabboSoundTypesEnum.const_946);
         }
         this.var_2024 = false;
         if(this.var_271 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_80,this.var_95.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2026 && this.var_534 != null)
         {
            this.var_534.playSound(HabboSoundTypesEnum.const_1033);
         }
         this.var_2026 = false;
         if(this.var_271 != null)
         {
         ...
         if(_loc2_.type == Purse.const_175)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_121,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_121,_loc2_.points["null"]));
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_985.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_314.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2025 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_271 == null)
         {
            this.var_271 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_271.showChargeInfo(_loc2_);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "AssetLoaderEventBroker" == this.var_170.getKey("client.credits.embed.enabled"))
            {
