package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1944:String = "hd-99999-99999";
      ...
      private var var_669:PaletteManager;
      
      private var var_629:String;
      
      private var var_274:Map;
      
      private var var_203:AvatarAssetDownloadManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_629 = RenderMode.const_1600;
         ...
         this.var_97.add(AvatarType.const_113,_loc4_);
         ...
         this.var_669 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_203)
         {
            this.var_203.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_325.init();
         this.var_669.init();
         _loc2_ = this.var_97.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_97.getValue(AvatarType.const_113) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_203 == null)
               {
                  ...
                  this.var_203 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_203.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_797)
         {
            if(this.var_2147 && this.var_2148 && this.var_2149)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_203.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_203.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_97.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_203.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1575)
         {
            this.var_1575 = new AvatarFigureContainer(this.const_1944);
         }
         this.var_203.loadFigureSetData(_loc6_,param4);
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1487)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_97.getValue(AvatarType.const_113) as AvatarStructure;
