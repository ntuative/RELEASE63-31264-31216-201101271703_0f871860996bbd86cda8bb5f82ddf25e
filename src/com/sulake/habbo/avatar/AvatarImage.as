package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_532:AvatarFigureContainer;
      ...
      private var var_2387:String = null;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_246.length == 1 && this.var_85 == this.var_1963)
         {
            return this.var_85 + this.var_486 + this.var_579 % 4;
         }
         if(this.var_246.length == 2)
         {
            for each(_loc1_ in this.var_246)
            {
               ...
               {
                  return this.var_85 + this.var_486 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_579 % 11;
                  return this.var_85 + "_" + this.var_1963 + this.var_486 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2388 || param2 != this.var_2387 || param1 != this.var_2389)
         {
            this.var_2388 = param3;
            this.var_2387 = param2;
            this.var_2389 = param1;
            this.var_1712 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_264.definition.geometryType,this.var_85);
         this.var_43.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_579);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_579);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_304.push(new ActiveActionData(param1,param2,this.var_579));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_876);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_486 = "";
         this.var_246 = this._structure.sortActions(this.var_304);
         if(this.var_246 == null)
         {
         ...
         {
            this.var_684 = this._structure.getCanvasOffsets(this.var_246,this._scale,this.var_85);
            for each(_loc4_ in this.var_246)
            {
               this.var_486 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_292)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1346 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1346 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_246)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_296 || _loc1_.actionType == AvatarAction.const_214 || _loc1_.actionType == AvatarAction.const_384)
               {
                  this.var_875 = true;
               }
            }
