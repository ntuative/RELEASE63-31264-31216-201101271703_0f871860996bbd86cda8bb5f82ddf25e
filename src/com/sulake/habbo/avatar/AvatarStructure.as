package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_381:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_918:AvatarActionManager;
      
      private var var_354:FigureData;
      
      private var var_410:PartSetsData;
      
      private var var_499:AnimationData;
      
      private var var_746:AnimationManager;
      
      private var var_876:ActionDefinition;
      
      private var var_502:String;
      
      private var var_1390:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_381 = param1;
         this.var_354 = new FigureData();
         this.var_410 = new PartSetsData();
         this.var_499 = new AnimationData();
         this.var_746 = new AnimationManager();
         this.var_502 = param2;
      ...
      {
         this.var_1390.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_918 = new AvatarActionManager(param1,this.var_502,param2);
         this.var_876 = this.var_918.getDefaultAction();
      }
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         ...
         return this.var_499.parse(param1);
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         ...
         return this.var_354.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_354.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_746.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_354.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_354.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_746.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_746.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_918.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_918.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_918.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_607[param1] = new Dictionary();
         }
         if(this.var_607[param1][param2])
         {
            return this.var_607[param1][param2];
         }
         this.var_607[param1][param2] = this.var_354.getMandatorySetTypeIds(param1,param2);
         return this.var_607[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_354.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_918.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_746.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1564[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_499.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_746.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_354.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_354.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1390.getOffset(param1,param2,param3,param4,param5,param6);
      }
