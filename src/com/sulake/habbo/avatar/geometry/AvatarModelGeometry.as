package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1755:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_899.x = _loc11_;
            this.var_899.y = _loc12_;
            this.var_899.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_736[String(_loc6_.@id)] = _loc7_;
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1755.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1755.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_155[param1];
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_736[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_736[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_736[param1] as Dictionary;
         }
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         for each(_loc7_ in _loc5_)
         {
            ...
            _loc9_ = _loc7_.getDistance(this.var_899);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(this.var_1127,this.var_899,param4);
         }
         return [];
      }
