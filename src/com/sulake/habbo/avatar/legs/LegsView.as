   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_248,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_212,_windowManager,_assetLibrary);
         }
         else
         {
