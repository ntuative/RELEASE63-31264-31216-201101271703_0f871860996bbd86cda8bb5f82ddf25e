package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_405.getValue(_loc4_) == null)
               {
                  this.var_405.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      public function removeListener(param1:IPetDataListener = null) : void
      {
         ...
         var _loc2_:int = this.var_495.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_495.splice(_loc2_,1);
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_495.length > 0)
         {
            _loc1_ = this.var_495.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_405.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc4_:PetData = this.var_405.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_405.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_405.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1376.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_594.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_495.indexOf(param3) == -1)
                  {
                     this.var_495.push(param3);
                  }
               }
            }
         }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_263.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
