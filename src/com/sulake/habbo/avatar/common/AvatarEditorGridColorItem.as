package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_775 = _loc4_.content as BitmapData;
         ...
         this.var_870 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_775.width,this.var_775.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_775,this.var_775.rect,new Point(0,0));
         }
