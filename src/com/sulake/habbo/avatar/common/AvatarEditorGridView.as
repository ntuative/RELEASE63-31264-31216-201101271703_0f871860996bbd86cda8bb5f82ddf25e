package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this._view != null)
         {
            this.var_543 = this._view.findChildByName("part_thumbs") as IItemGridWindow;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_65.getCategoryData(this.var_1251);
         if(!_loc1_)
         {
            return;
         }
         this.var_543.removeGridItems();
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               this.var_543.addGridItem(_loc2_.view);
      ...
      {
         var _loc3_:IWindow = this.var_543.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_543.getGridItemIndex(param1.window);
            this.var_65.selectPart(this.var_1251,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            while(_loc7_ < this.const_1313)
            {
               if(this.var_448.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_65.selectColor(this.var_1251,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
