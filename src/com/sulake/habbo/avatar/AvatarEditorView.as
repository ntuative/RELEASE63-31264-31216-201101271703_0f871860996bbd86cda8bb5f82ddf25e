package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1200:IWindowContainer;
      
      public static var var_1464:IWindowContainer;
      
      public static var var_1928:int = 6710886;
      ...
      private var var_473:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1078 = [];
         this.var_1316 = [AvatarEditorFigureCategory.const_728,AvatarEditorFigureCategory.const_46,AvatarEditorFigureCategory.const_243,AvatarEditorFigureCategory.const_647,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_99];
         super();
         ...
         if(var_1200 == null)
         {
            ...
            var_1200 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1464 == null)
         {
         ...
         this.var_391 = new Timer(1000);
         this.var_391.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1316;
         }
         for each(_loc6_ in param4)
         {
            this.var_1078.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_391.stop();
            this.var_391.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_391 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1316);
         }
         if(param1.length != this.var_1078.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2268 = this.canChangeOutfit();
            this.var_391.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_473 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_473.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_473.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1078.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_473.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_473.numSelectables)
               {
                  this.var_473.getSelectableAt(_loc6_).x = this.var_473.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1316;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1670 == AvatarEditorSideCategory.const_99 || this.var_2269))
         {
      ...
      {
         if(this.var_1670 == AvatarEditorSideCategory.const_99)
         {
            this.var_2269 = false;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_358 = param1;
         this.var_473.setSelected(this.var_473.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_472)
         {
            ...
            this.var_472 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_472.procedure = this.stripClubDialogEventProc;
            this.var_472.center();
         }
         else
         {
