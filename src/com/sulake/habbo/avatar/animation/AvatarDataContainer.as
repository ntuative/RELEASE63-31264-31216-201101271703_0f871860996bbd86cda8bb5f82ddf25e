package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1902:Number = 1.0;
      
      private var var_1904:Number = 1.0;
      
      private var var_1903:Number = 1.0;
      ...
      {
         super();
         this.var_1719 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2410 = parseInt(_loc2_,16);
         this.var_2412 = parseInt(_loc3_,16);
         ...
         this.var_1810 = new ColorTransform(this.var_1902,this.var_1904,this.var_1903,this._alphaMultiplier);
         this.var_1108 = this.generatePaletteMapForGrayscale(this.var_2412,this.var_2410);
      }
      ...
      {
         return this.var_1108.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1108.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1108.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1108.getValue("alphas") as Array;
      }
