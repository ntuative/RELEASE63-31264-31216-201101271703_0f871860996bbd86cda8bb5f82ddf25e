package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1647:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1367:IAvatarImage;
      ...
      private var var_316:IActiveActionData;
      ...
      private var var_160:BitmapData;
      ...
      private var var_374:BitmapDataAsset;
      ...
      private var var_1529:PaletteMap;
      
      private var var_820:Array;
      
      private var var_819:Point;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_655 == GeometryType.const_1108 && param1 == GeometryType.const_1041 || this.var_655 == GeometryType.const_1041 && param1 == GeometryType.const_1108)
         {
            this.var_655 = param1;
            this.var_81 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_316 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_316;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_316 || !this.var_316.definition))
         {
            if(this.var_316.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_316.definition.state + "." + this.var_316.actionParameter);
               _loc13_ = param2 - this.var_316.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_316.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_457)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1367.getFigure(),_loc5_,this.var_655,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_414 == null)
         {
            ...
            this.var_414 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_316);
            if(this.var_414 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_81)
         {
            ...
            this.var_2068 = new Point(0,this.var_81.height - int(this.var_81.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1611[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_780 || _loc10_ == AvatarAction.const_384;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1259 = this.var_103.bodyPartId;
               this.var_161 = this.var_103.partType;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_103.flippedPartType != this.var_161)
                     {
                        this.var_161 = this.var_103.flippedPartType;
                     }
                  }
               }
               this.var_1260 = this._scale + "_" + this.var_103.action.assetPartDefinition + "_" + this.var_161 + "_" + this.var_1530 + "_" + _loc5_ + "_" + this._frame;
               this.var_374 = this._assets.getAssetByName(this.var_1260) as BitmapDataAsset;
               if(this.var_374 == null)
               {
                  this.var_1260 = this._scale + "_std_" + this.var_161 + "_" + this.var_1530 + "_" + _loc5_ + "_0";
                  this.var_374 = this._assets.getAssetByName(this.var_1260) as BitmapDataAsset;
               }
               if(!(!this.var_374 || !this.var_374.content))
               {
                  if(this.var_103.paletteMapId > -1)
                  {
                     this.var_1529 = this._structure.renderManager.paletteManager.getPalette(this.var_103.paletteMapId);
                     if(this.var_1529 != null)
                     {
                        this.var_821 = this.var_374.content as BitmapData;
                        this.var_160 = new BitmapData(this.var_821.width,this.var_821.height);
                        this.var_2069 = this.var_1529.colorize(this.var_821.getPixels(this.var_821.rect));
                        this.var_160.setPixels(this.var_160.rect,this.var_2069);
                     }
                     else
                     {
                        this.var_160 = (this.var_374.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1259 == AvatarBodyPartType.const_243 || this.var_1259 == AvatarBodyPartType.const_1569 || this.var_1259 == AvatarBodyPartType.const_1592) && this.var_103.color != null)
                  {
                     _loc16_ = 0.7;
                     ...
                     this.var_160.colorTransform(this.var_160.rect,_loc18_);
                  }
                  else if(this.var_103.isColorable && this.var_103.color != null)
                  {
                     this.var_160.colorTransform(this.var_160.rect,this.var_103.color.colorTransform);
                  }
                  if(this.var_103.isBlendable)
                  {
                     this.var_160.colorTransform(this.var_160.rect,this.var_103.blendTransform);
                  }
                  this.var_819 = this.var_374.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_53)
                     {
                  ...
                  this.var_2070 = new ImageData(this.var_160,this.var_819,_loc7_);
                  this.var_820.push(this.var_2070);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_820,_loc6_);
         ...
         _loc8_ = this.var_820.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_820.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
