package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_140 = param1;
         this._communication = this.var_140.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_140.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_140.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_140.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaign(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length == 0)
         {
            ...
            this.var_656 = this.var_140.windowManager.alert("quest.nocampaigns.title","quest.nocampaigns.desc",0,this.onCloseAlert);
         }
         else
         {
            this.var_140.controller.openCampaigns(_loc2_.campaignCodes);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.campaignCodes.length > 0)
         {
            this.var_140.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_140.toolbar != null && this.var_140.configuration != null)
         {
            _loc2_ = this.var_140.configuration.getKey("questing.supportMultipleCampaigns","");
            _loc3_ = this.var_140.configuration.getKey("questing.defaultCampaign","");
            if(_loc3_ && _loc3_ != "" || _loc2_ && _loc2_ == "AssetLoaderEventBroker")
            {
               this.var_140.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      {
         this.var_140.controller.close();
         this.var_140.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.QUESTS));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_140.controller.updatePurse();
      }
