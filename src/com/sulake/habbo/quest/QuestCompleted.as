package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_207 = IFrameWindow(this.var_62.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_207.findChildByName("description").caption = this.var_62.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_207.findChildByName("reward.currency.desc").caption = this.var_62.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
