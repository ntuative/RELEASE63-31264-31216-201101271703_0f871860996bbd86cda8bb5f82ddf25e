package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2674:uint = 2;
      
      private var var_2673:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1617 = param1.roomItemTypeName;
         this.var_1616 = param1.rewardCurrencyAmount;
         this.var_1895 = new Date();
         this.var_1895.setTime(param1.endDateTimeStamp);
         this.var_688 = param1.localizationCode;
      ...
      private function createView() : void
      {
         switch(this.var_366)
         {
            case QuestStatusEnum.const_44:
               ...
               break;
            case QuestStatusEnum.const_498:
            ...
            case QuestStatusEnum.const_186:
               ...
               break;
            case QuestStatusEnum.const_846:
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_62.code,this.var_688].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_193)
            {
               this.var_866.style = this.var_2673;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_193)
            {
               this.var_866.style = this.var_2674;
            }
         }
      }
