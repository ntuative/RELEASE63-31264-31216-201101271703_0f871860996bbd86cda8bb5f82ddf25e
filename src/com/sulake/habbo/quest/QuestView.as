package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1799:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_93.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1799 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
      ...
      private function localize() : void
      {
         ...
         {
            _loc33_ = this.var_62.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_93.roomItemTypeName);
            if(_loc33_)
            {
               _loc34_ = this.var_62.controller.questEngine.roomEngine.getFurnitureImage(_loc33_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1800 = _loc34_.id;
