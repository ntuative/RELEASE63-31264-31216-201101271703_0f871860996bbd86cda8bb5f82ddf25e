package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_863 != null)
         {
            if(this.var_165.isActive)
            {
               ...
               this.var_863.width = _loc2_ * this.var_278;
            }
            else
            {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_864.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_864.text;
            if(this.var_165.isActive)
            {
               ...
               this.var_864.text = _loc1_;
            }
            else
            {
               this.var_864.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_862 = this._window.findChildByName("effect_hilite");
            this.var_862.visible = false;
         }
         this.var_864 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_863 = this._window.findChildByName("loader_bar");
         if(this.var_863 != null)
         {
            this.var_278 = this.var_863.width;
            this.var_187.start();
            this.onUpdate();
         }
