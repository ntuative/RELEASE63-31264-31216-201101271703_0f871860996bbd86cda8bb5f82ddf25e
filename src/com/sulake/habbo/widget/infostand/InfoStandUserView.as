package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_758:IWindow;
      
      private var var_219:IBorderWindow;
      
      private var var_1054:TagListRenderer;
      
      private var var_129:IBorderWindow;
      
      private var var_2596:int;
      
      private const const_938:int = 5;
      ...
      private const const_1972:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1054 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_50 == null || this.var_219 == null || this.var_64 == null)
         {
            return;
         }
         this.var_64.width = this.var_64.scrollableRegion.width;
         this.var_50.height = this.var_50.scrollableRegion.height;
         this.var_219.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_219.width,this.var_64.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_219.width < this.var_64.width)
         {
            this.var_219.x = this._window.width - this.var_219.width;
            this.var_64.x = 0;
         }
         else
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_219 = this._window.getListItemByName("info_border") as IBorderWindow;
         ...
         {
            this.var_50 = this.var_219.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_219.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_219.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_219.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_219.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_938;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_938;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1054.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_191:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_260:
               ...
               this.showButton("give_badge",param1.givableBadges.length > 0);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1098:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1155:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2596 > this.const_1972 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
      ...
      {
         this.var_191 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_191.center();
         this.var_191.procedure = this.badgesEventProc;
         this.var_191.visible = param1;
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_758 = null;
         var _loc2_:IItemGridWindow = this.var_191.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_191.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_191.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_758);
               }
               if(_loc3_ <= -1)
               {
                  return;
