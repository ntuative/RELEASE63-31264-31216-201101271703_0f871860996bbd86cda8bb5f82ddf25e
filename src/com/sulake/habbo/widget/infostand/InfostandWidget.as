package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1392:InfostandUserData;
      
      private var var_515:InfostandFurniData;
      
      private var var_1326:InfoStandPetData;
      ...
      private const const_1971:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1148 = new InfoStandFurniView(this,this.const_1681,this._catalog);
         this.var_156 = new InfoStandUserView(this,this.const_1679);
         this.var_355 = new InfoStandPetView(this,this.const_1678);
         this.var_412 = new InfoStandBotView(this,this.const_1680);
         this.var_1392 = new InfostandUserData();
         this.var_515 = new InfostandFurniData();
         this.var_1326 = new InfoStandPetData();
         this.var_157 = new Timer(this.const_1971);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_213,this.onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_319,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_260,this.onUserInfo);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.onBotInfo);
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_796,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_84,this.onUserBadges);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_213,this.onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_319,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_260,this.onUserInfo);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.BOT,this.onBotInfo);
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_796,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_84,this.onUserBadges);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_327,this.var_355.getCurrentPetId()));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_156.setTags(param1.tags,this.var_2547);
         }
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc4_.length > 0)
         {
            this.var_156.setGivableBadgeImage(_loc4_,param1.badgeImage);
            return;
         }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_144:
               _loc2_ = param1.id == this.var_515.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_319:
               if(this.var_156 != null && this.var_156.window != null && this.var_156.window.visible)
               {
                  _loc2_ = param1.id == this.var_1392.userRoomId;
                  break;
               }
               if(this.var_355 != null && this.var_355.window != null && this.var_355.window.visible)
               {
                  _loc2_ = param1.id == this.var_1326.roomIndex;
                  break;
               }
