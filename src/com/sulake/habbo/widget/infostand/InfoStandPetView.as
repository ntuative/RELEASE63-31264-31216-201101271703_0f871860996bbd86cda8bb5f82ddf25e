package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1957:int = 16;
      
      private const const_1958:uint = 11184810;
      
      private const const_1962:uint = 6710886;
      
      private const const_1961:uint = 3355443;
      
      private const const_1959:String = "level";
      
      private const const_1964:String = "experience";
      
      private const const_1965:String = "energy";
      
      private const const_1963:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1959,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1964,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1965,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1963,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1326.remove(param1.id);
         this.var_1326.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1960,this.const_1957,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1958);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1961);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1326.getValue(this.var_470) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = this.var_219.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_219.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_188 && this.var_188.getPetId() == this.var_470)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_452,this._widget.petData.ownerId);
