package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1332:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_177.state = RoomChatHistoryPulldown.const_209;
         ...
         this.var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_977,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_177.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_209);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_177.state == RoomChatHistoryPulldown.const_369 || this.var_177.state == RoomChatHistoryPulldown.const_541;
      }
      ...
      {
         if(!this.var_423 && !this.var_1763)
         {
            this.var_423 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_177.state = RoomChatHistoryPulldown.const_369;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_46 != null)
         {
            ...
            if(param2)
            {
               this.var_46.scrollV = this.var_630;
            }
         }
         if(this.var_177 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_422 > 0 && param2)
         {
            if(this.var_1896)
            {
               if(Math.abs(param1 - this.var_422) <= const_1114)
               {
                  return;
               }
               this.var_1896 = false;
            ...
            if(this.var_423)
            {
               ...
               _loc5_ = (param1 - this.var_422) / this.var_46.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_46.scrollV < 1 - const_1332 / this.var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1897)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_630 = this.var_46.scrollV;
         }
         if(this.var_46 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_630 - this.var_46.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
