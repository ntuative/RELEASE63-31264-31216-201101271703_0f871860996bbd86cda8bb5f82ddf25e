package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_883:int = 6;
      ...
      private static var var_211:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_211)
         {
            var_211 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_speak").content as XML,1) as IRegionWindow;
            var_211.tags.push("roomchat_bubble");
            var_211.x = 0;
            var_211.y = 0;
            var_211.width = 0;
            var_211.background = true;
            var_211.mouseThreshold = 0;
            var_211.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
         if(!var_400)
         {
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         this.var_1110 = param1.userCategory;
         this._message = param1.text;
         this.var_487 = param1.links;
         this.var_1729 = param1.userX;
      ...
      public function set y(param1:Number) : void
      {
         ...
         if(this._window != null)
         {
            this._window.y = param1 - this.var_728;
         }
      }
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_176,this.width,const_917);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1357)
         {
            case RoomWidgetChatUpdateEvent.const_138:
               this._window = var_211.clone() as IRegionWindow;
               break;
         ...
         if(this.var_250 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_728 = Math.max(0,(this.var_250.height - background.height) / 2);
         ...
         if(this.var_1357 == RoomWidgetChatUpdateEvent.const_316)
         {
            textWindow.text = this._localizations.registerParameter("widgets.chatbubble.respect","username",this.var_891);
            this._width = const_918;
         }
         else if(this.var_1357 == RoomWidgetChatUpdateEvent.const_308)
         {
            textWindow.text = this._localizations.registerParameter("widget.chatbubble.petrespect","petname",this.var_891);
            this._width = const_918;
         }
         else if(this.var_487 == null)
         {
         ...
         else
         {
            ...
            lastLinkEndPos = -1;
            i = 0;
            while(i < this.var_487.length)
            {
               filteredLink = this.var_487[i][1];
               placeHolder = "{" + i + "}";
               placeholderPos = this._message.indexOf(placeHolder);
               lastLinkEndPos = placeholderPos + filteredLink.length;
               this.var_729.push([placeholderPos,lastLinkEndPos]);
         ...
         if(textWindow.visible)
         {
            ...
            textWindow.y += this.var_728;
            messageWidth = textWindow.textWidth;
            textWindow.width = messageWidth + const_883;
         ...
         this._window.y -= this.var_728;
         this._width = this._window.width;
         background.bitmap = bitmap;
         background.y = this.var_728;
      }
      ...
      private function onMessageLinkMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this.var_729.length)
         {
            if(_loc2_ >= this.var_729[_loc3_][0] && _loc2_ <= this.var_729[_loc3_][1])
            {
               if(this.var_487[_loc3_][2] == 0)
               {
                  HabboWebTools.openExternalLinkWarning(this.var_487[_loc3_][0]);
               }
               else if(this.var_487[_loc3_][2] == 1)
               {
                  HabboWebTools.openWebPage(this.var_1730 + this.var_487[_loc3_][0],"habboMain");
               }
               else
               {
                  HabboWebTools.openWebPage(this.var_1730 + this.var_487[_loc3_][0]);
               }
            }
            _loc3_++;
         }
      ...
      {
         this._widget.onItemMouseClick(this.var_1111,this.var_891,this.var_1110,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1111,this.var_1110,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1111,this.var_1110,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1111,this.var_1110,this._roomId,this._roomCategory,param1);
      }
