package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1198,const_1197,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_406 != null)
         {
            this.var_406.setValue(this.var_1377);
         }
         this.var_441 = this.colors.indexOf(_loc2_.color);
         if(this.var_595 != null)
         {
            this.var_595.setSelectedColorIndex(this.var_441);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1378 = XML(_loc1_.content);
         return this.var_1378;
      }
