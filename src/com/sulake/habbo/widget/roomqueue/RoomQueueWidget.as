package com.sulake.habbo.widget.roomqueue
{
   ...
   public class RoomQueueWidget extends RoomWidgetBase
   {
      ...
      private function onQueueStatus(param1:RoomWidgetRoomQueueUpdateEvent) : void
      {
         ...
         if(param1.isActive)
         {
            this.var_1514 = param1.type;
            this.var_1246 = false;
            this.var_993 = param1.position;
         }
         else
         {
            this.var_1246 = true;
         }
         this.var_2040 = param1.hasHabboClub;
         this.var_1513 = param1.isClubQueue;
         localizations.registerParameter("room.queue.position","position",this.var_993.toString());
         localizations.registerParameter("room.queue.position.hc","position",this.var_993.toString());
         localizations.registerParameter("room.queue.spectator.position","position",this.var_993.toString());
         localizations.registerParameter("room.queue.spectator.position.hc","position",this.var_993.toString());
         this.showInterface();
      }
      ...
      private function exitQueue(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:RoomWidgetRoomQueueMessage = new RoomWidgetRoomQueueMessage(RoomWidgetRoomQueueMessage.const_740);
      ...
      private function changeQueue(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_1514 == RoomWidgetRoomQueueUpdateEvent.const_359)
         {
            _loc2_ = new RoomWidgetRoomQueueMessage(RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE);
         }
         else
         {
            _loc2_ = new RoomWidgetRoomQueueMessage(RoomWidgetRoomQueueMessage.const_663);
         }
         messageListener.processWidgetMessage(_loc2_);
         this.removeWindow();
      }
