package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_998:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_998.getValue());
      ...
      {
         this.var_87 = param2;
         this.var_998 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_998.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_998.setValue(1);
         this.var_999 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_999.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_999.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_998.setValue(_loc3_);
         this.var_999.setValue(_loc4_);
      }
