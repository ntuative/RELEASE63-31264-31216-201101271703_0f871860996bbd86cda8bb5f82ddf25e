package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1499:TriggerConfs;
      
      private var var_1500:ActionTypes;
      
      private var var_1498:ConditionTypes;
      
      private var var_226:Dictionary;
      
      private var var_59:Triggerable;
      
      private var var_648:RoomObjectHightLighter;
      
      private var var_163:UserDefinedRoomEventsHelp;
      
      private var var_984:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1499 = new TriggerConfs();
         this.var_1500 = new ActionTypes();
         this.var_1498 = new ConditionTypes();
         this.var_226 = new Dictionary();
         super();
         this.var_87 = param1;
         this.var_648 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_226[param1])
         {
            ...
            this.var_648.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_59.furniLimit)
         {
            this.var_226[param1] = param2;
            this.var_648.show(param1);
         }
         this.refresh();
      }
      ...
      {
         return this.resolveHolder().getElementByCode(this.var_59.code);
      }
      
      private function resolveHolder() : ElementTypeHolder
      {
         if(this.var_59 as TriggerDefinition != null)
         {
            return this.var_1499;
         }
         if(this.var_59 as ActionDefinition != null)
         {
            return this.var_1500;
         }
         if(this.var_59 as ConditionDefinition != null)
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_984 = new SliderWindowController(this.var_87,IWindowContainer(this.find(this.var_86,"delay_slider_container")),this.var_87.assets,0,20,1);
         this.var_984.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_984.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_648.hideAll(this.var_226);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.prepareWindow();
         this.var_59 = param1;
         Logger.log("Received: " + this.var_59 + ", " + param1.code);
         var _loc2_:Element = this.resolveType();
         this.var_648.hideAll(this.var_226);
         this.var_226 = new Dictionary();
         for each(_loc3_ in this.var_59.stuffIds)
         {
            this.var_226[_loc3_] = "yes";
         }
         _loc4_ = !!_loc2_.hasSpecialInputs ? this.prepareCustomInput() : null;
         _loc2_.onEditStart(_loc4_,this.var_59);
         this.var_648.showAll(this.var_226);
         if(this.var_59 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_59);
            _loc6_ = _loc5_.delayInPulses;
            this.var_984.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_59 as TriggerDefinition != null)
         {
            this.var_87.send(new UpdateTriggerMessageComposer(this.var_59.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_59 as ActionDefinition != null)
         {
            this.var_87.send(new UpdateActionMessageComposer(this.var_59.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_59 as ConditionDefinition != null)
         {
            this.var_87.send(new UpdateConditionMessageComposer(this.var_59.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_984.getValue()) : 0;
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_87.send(new ApplySnapshotMessageComposer(this.var_59.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1500);
      ...
      {
         if(!param1.acceptTriggerable(this.var_59))
         {
      ...
      private function refreshHeader(param1:Element, param2:String) : void
      {
         ...
         this.setText(_loc3_,"conf_name_txt",this.getElementName(this.var_59.stuffTypeId));
         this.setText(_loc3_,"conf_desc_txt",this.getElementDesc(this.var_59.stuffTypeId));
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         var _loc1_:ActionDefinition = ActionDefinition(this.var_59);
      ...
      private function refreshConflictingActions() : void
      {
         ...
         var _loc1_:TriggerDefinition = TriggerDefinition(this.var_59);
      ...
      private function refreshSelectFurni() : void
      {
         ...
         var _loc4_:int = this.var_59.furniLimit;
