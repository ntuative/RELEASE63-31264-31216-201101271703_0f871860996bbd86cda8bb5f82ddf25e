package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_1009:SliderWindowController;
      ...
      {
         return ActionTypeCodes.var_1918;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1009.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_87 = param2;
         this.var_1010 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_1010.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_1010.setValue(1);
         this.var_1009 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1009.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_1009.setValue(1);
      }
