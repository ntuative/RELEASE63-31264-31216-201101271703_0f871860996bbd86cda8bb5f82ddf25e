package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1056:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1631 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1055 = this.var_1631.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1055)
         {
            this.var_1055.procedure = this.onButtonClick;
         }
         this.var_1056 = this.var_1631.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1056)
         {
            this.var_1056.procedure = this.onButtonClick;
         }
