package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1173:IItemGridWindow;
      
      private var var_1172:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1173 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1173.procedure = this.inactiveGridEventProc;
         this.var_1172 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1172.procedure = this.activeGridEventProc;
      }
      ...
      private function updateListViews() : void
      {
         ...
         this.var_1173.removeGridItems();
         this.var_1172.removeGridItems();
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               this.var_1173.addGridItem(_loc2_.window);
         ...
         while(_loc3_ < _loc4_.length)
         {
            ...
            this.var_1172.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_1173.getGridItemIndex(param1.window);
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1172.getGridItemIndex(param1.window);
