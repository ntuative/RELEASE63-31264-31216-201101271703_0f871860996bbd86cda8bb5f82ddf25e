package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_886:int = 1;
      
      private const const_1666:int = 2;
      
      private const const_1669:int = 3;
      
      private const const_1667:int = 42;
      
      private const const_1668:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_488.add(FurniModel.const_43,new FurniGridView(this.var_65,FurniModel.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_488.add(FurniModel.const_47,new FurniGridView(this.var_65,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_488.getValue(this.var_401);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_65.getCategoryContent(this.var_401);
         if(!this.var_65.isListInited())
         {
            _loc2_ = this.const_886;
         }
         ...
         {
            _loc2_ = this.const_1669;
         }
         if(this.var_2437 == _loc2_)
         {
            return;
         }
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_488.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_488.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_488.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_65.getGroupItemInIndex(_loc3_,this.var_401);
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1668)
         {
            _loc3_ = this.const_1668;
         }
         else if(_loc3_ < this.const_1667)
         {
            _loc3_ = this.const_1667;
         }
         else
         {
