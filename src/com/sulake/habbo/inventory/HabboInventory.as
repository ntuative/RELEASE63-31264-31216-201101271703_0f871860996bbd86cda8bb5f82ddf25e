package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1077:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_17 != null)
         {
            ...
            this.var_17.events.removeEventListener(RoomSessionEvent.const_96,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_470,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_48.getValue(InventoryCategory.const_82));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_48.getValue(InventorySubCategory.const_291));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_48.getValue(InventoryCategory.const_750));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_48.getValue(InventoryCategory.const_275));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_48.getValue(InventoryCategory.const_331));
      }
      ...
      {
         return PetsModel(this.var_48.getValue(InventoryCategory.const_153));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_48.getValue(InventoryCategory.const_385) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_96,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_470,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               this.var_1077 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_470:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_393 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_17 || !this.var_169)
         {
            return;
         }
         ...
         this.var_48.add(InventoryCategory.const_385,_loc1_);
         ...
         this.var_48.add(InventoryCategory.const_750,_loc4_);
         ...
         this.var_48.add(InventoryCategory.const_331,_loc5_);
         ...
         this.var_48.add(InventorySubCategory.const_291,_loc6_);
         ...
         this.var_48.add(InventoryCategory.const_153,_loc8_);
         this.var_180 = true;
         if(this.var_2663)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_291:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_945.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1974);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1170));
      }
