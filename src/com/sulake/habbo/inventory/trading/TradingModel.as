package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1506:uint = 9;
      
      public static const const_172:uint = 0;
      
      public static const const_196:uint = 1;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_51.updateItemList(this.var_661);
         this.var_51.updateItemList(this.var_1269);
      ...
      public function close() : void
      {
         if(this.var_709)
         {
            if(this._state != const_172 && this._state != const_240)
            {
      ...
      {
         this.var_51.setMinimized(param1 != InventoryCategory.const_82);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_662 + " OTHER: " + this.var_1014);
         ...
         {
            case const_172:
               if(param1 == const_196 || param1 == const_240)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_272.length)
         {
            _loc2_ = this.var_272.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_51.alertPopup(TradingView.const_1090);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1014 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_51.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_51.alertPopup(TradingView.const_1004);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_272.length < const_1506)
         {
