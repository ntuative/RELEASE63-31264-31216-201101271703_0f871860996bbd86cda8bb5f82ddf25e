package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_900:uint = 4284532064;
      ...
      private var var_392:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_392 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1671 = this.createMinimizedWindow();
         }
         if(!this.var_2270)
         {
            return this.var_67;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_900) : uint(const_899);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_900) : uint(const_899);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1187)
            {
            ...
            this.var_392.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_555);
            this.var_392.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_392.hideDelayed();
         }
      }
