package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2754:IWindowContainer;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_169)
         {
            ...
            {
               this.var_169.events.removeEventListener(HabboToolbarEvent.const_72,this.onHabboToolbarEvent);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_169 != null && this.var_1128)
         {
            this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1128 = false;
         }
         this._controller.inventoryViewOpened(this.var_738);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_737 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_169 != null && this.var_1128)
            {
               this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1128 = false;
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_738);
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_737 == InventoryCategory.const_153)
            {
               this.toggleCategoryView(InventoryCategory.const_153);
            }
            else if(this.var_737 == InventoryCategory.const_82)
            {
