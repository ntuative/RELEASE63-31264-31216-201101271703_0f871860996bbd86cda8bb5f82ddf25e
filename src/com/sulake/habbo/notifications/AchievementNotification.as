package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1661:String = "badge_bg_001_png";
      
      private const const_1956:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1673 = param6;
         this._localizations = param10;
         this._assets = param8;
         this.var_393 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_122,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2291 = this._localizations.getBadgeName(this.var_284);
         this.var_2292 = this._localizations.getBadgeDesc(this.var_284);
         this.var_2287 = this._localizations.getAchievementNameForFacebook(this.var_284,this.var_393.userName,this.var_393.realName,this.var_1322);
         this.var_2290 = this._localizations.getAchievementDescForFacebook(this.var_284,this.var_393.userName,this.var_393.realName,this.var_1322);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2288 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1726.toString());
         ...
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1673;
         var _loc17_:String = this.var_1673 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_2061);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1661);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1956) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2291);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2292);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2287);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2290);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_393.events.removeEventListener(BadgeImageReadyEvent.const_122,this.onBadgeImageReady);
            this.var_393 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1661);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_284,this._feedTitleFb,this.var_2288,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2289));
