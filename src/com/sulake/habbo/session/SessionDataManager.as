package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1615:GroupDetailsView;
      ...
      private var var_562:ProductDataParser;
      ...
      private var var_1613:UserTagManager;
      
      private var var_1287:BadgeImageManager;
      
      private var var_1044:HabboGroupInfoManager;
      
      private var var_844:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_843 = [];
         this.var_1613 = new UserTagManager(events);
         this.var_1044 = new HabboGroupInfoManager(this,events);
         this.var_844 = new IgnoredUsersManager(this);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_277)
         {
            this.var_277.removeEventListener(FurnitureDataParser.const_107,this.onFurnitureReady);
            this.var_277.dispose();
            this.var_277 = null;
         }
         if(this.var_562)
         {
            this.var_562.removeEventListener(ProductDataParser.const_107,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1287 = new BadgeImageManager(context.root.assets,events,this.var_170,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1613.communication = this._communication;
         this.var_1044.communication = this._communication;
         this.var_844.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_277)
         {
            ...
            this.var_277 = new FurnitureDataParser(this.var_460,this._wallItems,this.var_459,this._localization);
            this.var_277.addEventListener(FurnitureDataParser.const_107,this.onFurnitureReady);
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_1046 = _loc3_.respectLeft;
         this.var_687 = _loc3_.petRespectLeft;
         this.var_532 = _loc3_.figure;
         this.var_803 = _loc3_.sex;
         this.var_1680 = _loc3_.realName;
         this.var_844.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_532 = _loc2_.figure;
            this.var_803 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_532,this.var_803));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2191 = _loc2_.isOpen;
         this.var_2192 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1613.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1287.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1615 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1044.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1615.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1044.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1044.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1287.getBadgeImage(param1,BadgeImageManager.const_1144);
      }
      ...
      {
         return this.var_844.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_844.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_844.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1046 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1046 = this.var_1046 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_687 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_687 = this.var_687 - 1;
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_562 == null)
         {
            ...
            this.var_562 = new ProductDataParser(_loc2_,this.var_1047);
            this.var_562.addEventListener(ProductDataParser.const_107,this.onProductsReady);
         }
         return false;
      }
