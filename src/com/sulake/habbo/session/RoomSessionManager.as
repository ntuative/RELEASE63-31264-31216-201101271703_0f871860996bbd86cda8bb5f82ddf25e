   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_213)
         {
            ...
            {
               _loc1_ = this.var_213.getKey(0) as String;
               _loc2_ = this.var_213.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1739)
         {
            this.gotoRoom(this.var_2441,this.var_2443,this.var_1738);
            this.var_1739 = false;
            this.var_1738 = "";
         }
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               ...
               case RoomSessionHandler.const_1048:
                  break;
               case RoomSessionHandler.const_679:
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_213.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_213.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_213.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_213.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_213.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
