package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1933:int = 2500;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1002 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1002.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1257));
         this.var_1256.add(this.var_1257,getTimer());
         ++this.var_1257;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1256.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1933)
            {
      ...
      {
         return this.var_1002 as IUserDataManager;
      }
