package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1873:int = 1000;
      
      private static var var_940:Array = [];
      
      private static var var_1871:int = 200;
      ...
      {
         this.var_766 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_767 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_442 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1576);
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1872[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1434.getValue(param2.chatterName))
            {
               this.var_1434.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1434.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1435)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1436)
         {
