package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private static const const_571:int = 20;
      ...
      private var var_1667:IWindowContainer;
      
      private var var_2776:BitmapData;
      
      private var var_2775:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1667 = this.var_540.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_1667.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_1667 == null)
            {
               return;
            }
            ...
            if(_loc11_ != null)
            {
               ...
               _loc13_ = this.var_540.assets.getAssetByName(_loc12_) as BitmapDataAsset;
