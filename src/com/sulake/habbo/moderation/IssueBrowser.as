package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1945:String = "my_issues";
      
      private const const_1947:String = "open_issues";
      
      private const const_1946:String = "picked_issues";
      
      private const const_1977:String = "closed_issues";
      ...
      private var var_1597:IIssueBrowserView;
      
      private var var_1596:IIssueBrowserView;
      
      private var var_1598:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_327.view.width = this.var_237.container.width;
         this.var_327.view.height = this.var_237.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1945:
               ...
               {
                  this.var_1597 = new MyIssuesView(this.issueManager,this,this.var_237.container);
               }
               return this.var_1597;
            case this.const_1947:
               if(this.var_1596 == null)
               {
                  this.var_1596 = new OpenIssuesView(this.issueManager,this,this.var_237.container);
               }
               return this.var_1596;
            case this.const_1946:
               if(this.var_1598 == null)
               {
                  this.var_1598 = new PickedIssuesView(this.issueManager,this,this.var_237.container);
               }
