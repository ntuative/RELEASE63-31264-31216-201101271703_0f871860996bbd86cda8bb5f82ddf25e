package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_154.getHighestPriorityIssue();
         this.var_500 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         this.var_1145 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
         ...
         if(this.var_154.reportedUserId > 0)
         {
            this.var_1145.load(_loc4_,this.var_154.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_154.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_154.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_61 != null && this.var_61.issueManager != null && this.var_154 != null)
         {
            this.var_61.issueManager.removeHandler(this.var_154.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_154.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_154.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.closeBundle(this.var_154.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_61.issueManager.releaseBundle(this.var_154.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_154.getHighestPriorityIssue().issueId;
         this.var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_61,WindowTracker.const_1186,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_154.getHighestPriorityIssue();
            this.var_500 = new UserInfoCtrl(this._window,this.var_61,_loc3_.message);
