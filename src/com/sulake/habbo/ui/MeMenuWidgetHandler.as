   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_289,this.onFigureUpdate);
            }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_289,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1170,this.onAvatarEffectsChanged);
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_80,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1266)
            {
               ...
               this.var_1542 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1542;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + this.var_169 + " " + _loc6_);
            if(this.var_169 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1017,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               this.var_169.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_711);
         _loc1_.push(RoomWidgetDanceMessage.const_621);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_609);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_686);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_746);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_853);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_596);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_635);
         _loc1_.push(RoomWidgetStopEffectMessage.const_722);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1367);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_992);
         _loc1_.push(RoomWidgetToolbarMessage.const_709);
         _loc1_.push(RoomWidgetToolbarMessage.const_637);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_378);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1445);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1152);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_742);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_759);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_753);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1388);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_680);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_872);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_847);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_759:
               ...
               break;
            case RoomWidgetWaveMessage.const_711:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_621:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_609:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_686:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_746:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_635:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_987)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_171,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_596:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1188:
                        this._catalog.openCatalogPage(CatalogPageName.const_1614,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1025:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_275);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_722:
            ...
            case RoomWidgetNavigateToRoomMessage.const_992:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_742:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_709:
               ...
               if(this.var_169)
               {
                  this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
                  ...
                  {
                     this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_80,this._catalog.getPurse().credits));
                  }
               }
            ...
            case RoomWidgetToolbarMessage.const_637:
               ...
               {
                  this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_478,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_378:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_508));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_753:
            ...
            case RoomWidgetStoreSettingsMessage.const_680:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_379,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_872:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_379,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_847:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_445));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_380:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_783));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_723));
      }
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_80,param1.balance));
      }
