package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_652,RoomWidgetEcotronBoxOpenMessage.const_827,RoomWidgetEcotronBoxOpenedMessage.const_1630];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_652:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_827:
