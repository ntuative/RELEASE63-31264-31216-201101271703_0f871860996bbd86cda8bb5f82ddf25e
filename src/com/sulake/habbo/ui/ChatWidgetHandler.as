   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_376 != null)
         {
            ...
            {
               _loc2_ = this.var_376.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_683,RoomWidgetChatSelectAvatarMessage.const_757];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_683:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_757:
      ...
      {
         return [RoomSessionChatEvent.const_182];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_182:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_376.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_823.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_237:
                                       _loc17_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc16_,AvatarScaleType.const_90,this);
                                       if(_loc17_ != null)
                                       {
                                 ...
                                 {
                                    this.var_376.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_823.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1011 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1011);
            }
            if(this.var_657 == null)
            {
               ...
               this.var_449.y = 0;
               this.var_449.z = 0;
               this.var_657 = _loc4_.getScreenPoint(this.var_449);
               this.var_1011 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_449.x = 0;
            this.var_449.y = 0;
            this.var_449.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_449);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_657.x || _loc8_.y != this.var_657.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_657,_loc5_));
