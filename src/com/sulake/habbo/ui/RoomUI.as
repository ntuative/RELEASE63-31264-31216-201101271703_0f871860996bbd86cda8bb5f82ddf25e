package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1031:IRoomWidgetFactory;
      
      private var var_393:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_504:IAvatarRenderManager;
      ...
      private var var_289:IAdManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1134:IHabboHelp;
      
      private var var_905:IHabboModeration;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_534:IHabboSoundManager;
      ...
      private var var_1135:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1383 = RoomDesktop.const_504;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1031.release(new IIDHabboRoomWidget());
            this.var_1031 = null;
         }
         ...
         {
            this.var_534.release(new IIDHabboSoundManager());
            this.var_534 = null;
         }
         ...
         {
            this.var_504.release(new IIDAvatarRenderManager());
            this.var_504 = null;
         }
         ...
         {
            this.var_1134.release(new IIDHabboHelp());
            this.var_1134 = null;
         }
         ...
         {
            this.var_905.release(new IIDHabboModeration());
            this.var_905 = null;
         }
         ...
         if(this.var_1135)
         {
            this.var_1135.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1135 = null;
         }
         this.var_1764 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1031 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_504 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1764 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_289 != null && this.var_289.events != null)
         {
            this.var_289.events.addEventListener(AdEvent.const_432,this.adEventHandler);
            this.var_289.events.addEventListener(AdEvent.const_500,this.adEventHandler);
            this.var_289.events.addEventListener(AdEvent.const_412,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1134 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_905 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_905);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_534 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_17)
         {
            this.var_17.events.addEventListener(RoomSessionEvent.const_234,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionEvent.const_89,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionEvent.const_96,this.roomSessionStateEventHandler);
            this.var_17.events.addEventListener(RoomSessionChatEvent.const_182,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionChatEvent.const_486,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionUserBadgesEvent.const_84,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDoorbellEvent.const_108,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDoorbellEvent.const_125,this.roomSessionEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionViralFurniStatusEvent.const_518,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionViralFurniStatusEvent.const_475,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_266,this.roomSessionDialogEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_1103,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_1111,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_217,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_267,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_263,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_227,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_224,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_244,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_245,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_824,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_812,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_170,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_791,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionErrorMessageEvent.const_595,this.roomSessionDialogEventHandler);
            this.var_17.events.addEventListener(RoomSessionQueueEvent.const_546,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionVoteEvent.const_131,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionVoteEvent.const_126,this.roomSessionEventHandler);
            ...
            this.var_17.events.addEventListener(RoomSessionPollEvent.const_129,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionDimmerPresetsEvent.const_462,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionFriendRequestEvent.const_136,this.roomSessionEventHandler);
            this.var_17.events.addEventListener(RoomSessionUserNotificationEvent.const_111,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               if(param1.session != null)
               {
                  ...
                  this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.ZOOM));
                  this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.MEMENU));
                  this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      {
         this.var_1135 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_763,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_639,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_726,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_547,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_281,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_704,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_210,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_867,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_763)
         {
            if(this.var_17 != null)
            {
               this.var_17.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_476 || param1.type == RoomEngineEvent.const_547)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_639:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_837);
               ...
               if(this.var_1383 != RoomDesktop.const_504)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_293,this.var_1383);
               }
               if(this.var_289 != null)
               {
                  this.var_289.showRoomAd();
               }
               break;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1031;
         _loc3_.sessionDataManager = this.var_393;
         _loc3_.roomSessionManager = this.var_17;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_504;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_169;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1764;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_289;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1134;
         _loc3_.moderation = this.var_905;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_534;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1135;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_504)
            {
