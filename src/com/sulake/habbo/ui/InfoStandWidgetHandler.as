package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_122,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_122,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_658.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_658.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_452);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_797);
         _loc1_.push(RoomWidgetUserActionMessage.const_862);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_859);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_798);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_834);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_737);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1497);
         _loc1_.push(RoomWidgetPetCommandMessage.const_453);
         _loc1_.push(RoomWidgetPetCommandMessage.const_855);
         _loc1_.push(RoomWidgetUserActionMessage.const_556);
         _loc1_.push(RoomWidgetUserActionMessage.const_327);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_643);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_492)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_327 || param1.type == RoomWidgetUserActionMessage.const_556 || param1.type == RoomWidgetUserActionMessage.const_418)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_671:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1139,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_681:
               ...
               break;
            case RoomWidgetUserActionMessage.const_452:
            ...
            case RoomWidgetUserActionMessage.const_782:
               ...
               break;
            case RoomWidgetUserActionMessage.const_797:
               ...
               break;
            case RoomWidgetUserActionMessage.const_862:
            ...
            case RoomWidgetUserActionMessage.const_327:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_798:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_834:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_737:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_796);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_351);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1066);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_979);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_237)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_368)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1088)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_416);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_191)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_260)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc32_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_714);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1467;
                  if(!_loc27_)
                  {
                  ...
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1098;
                  }
                  if(!_loc29_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1155;
                  }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_84];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_84:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_658.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_53);
            this.var_658.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_714);
