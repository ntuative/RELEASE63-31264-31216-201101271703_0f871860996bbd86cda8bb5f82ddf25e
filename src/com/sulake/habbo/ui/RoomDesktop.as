package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      public static const const_504:int = -1;
      ...
      private var var_1031:IRoomWidgetFactory = null;
      
      private var var_393:ISessionDataManager = null;
      
      private var var_17:IRoomSessionManager = null;
      
      private var var_504:IAvatarRenderManager = null;
      ...
      private var var_1134:IHabboHelp = null;
      ...
      private var var_204:IToolTipWindow;
      
      private var var_2158:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_328,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_493,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_768,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_169 = param1;
         this.var_169.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         {
            this.var_184.toolbarSize = this.var_169.size;
            this.var_184.toolbarOrientation = this.var_169.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_328,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_493,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_768,this.onRoomContentLoaded);
         }
         ...
         {
            this.var_169.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
            this.var_169.events.removeEventListener(HabboToolbarEvent.const_40,this.onHabboToolbarEvent);
         }
         this.var_169 = null;
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_680 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
            if(this.var_680.length > 0)
            {
               this.var_1584 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_101));
            }
         }
         if(this.var_289 != null && this.var_31.state == RoomSessionEvent.const_234)
         {
            this.var_1585 = !this.var_289.showInterstitial();
         }
      ...
      {
         if(this.var_680 == null || this.var_680.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_680.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1031.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_679.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_679.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_679.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_618:
               ...
               if(this.var_905 != null && _loc3_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_USER)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_368)
                  {
                     this.var_905.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_281:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_502:
               ...
               break;
            case RoomEngineObjectEvent.const_867:
               if(!this.var_31.isRoomController && !this.var_393.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_133:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1031,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_146:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_620,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_547:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_118,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_476:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_1101,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc5_:int = 0;
         if(this.var_275.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         var _loc6_:DisplayObject = this._roomEngine.method_6(this.var_31.roomId,this.var_31.roomCategory,param1,_loc3_,_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_697);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_838);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_730);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_599);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_300,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2158);
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_300:
               _loc3_ = "null";
               break;
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_275[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_204 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_204.width / 2,15);
            this.var_204.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_275[0],_loc2_.width,_loc2_.height);
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1583) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.track("zoomEnded","ChargeConfirmationDialog",_loc3_);
               }
               else
               {
      ...
      {
         if(this.var_17 != null && this.var_31 != null && this.var_1585 && this.var_1584)
         {
            this.var_17.startSession(this.var_31);
            this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_313));
         }
      }
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_370);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_458:
               ...
               this.var_204 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_338,WindowStyle.const_785,WindowParam.const_95) as IToolTipWindow;
               this.var_204.setParamFlag(WindowParam.const_28,false);
