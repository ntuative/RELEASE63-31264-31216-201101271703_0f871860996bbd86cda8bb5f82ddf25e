package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1966:String = "room_widget";
      
      private var var_55:IWindowContainer;
      
      private var var_711:int = 50;
      
      private var var_2748:XML = null;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(this.const_1966) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_55.getChildByTag(this.const_1254) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         {
            case "LEFT":
               _loc2_.x = this.var_711;
               _loc2_.width = this.var_55.desktop.width - this.var_711;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = this.var_711;
               _loc2_.height = this.var_55.desktop.height - this.var_711;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = this.var_55.desktop.width;
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_55.findChildByTag(this.const_1254) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
