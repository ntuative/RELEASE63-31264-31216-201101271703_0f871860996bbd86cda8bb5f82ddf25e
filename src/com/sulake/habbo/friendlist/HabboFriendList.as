package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1079:IAvatarRenderManager;
      
      private var var_751:ISessionDataManager;
      
      private var var_2567:FriendListLookAndFeel;
      
      private var var_390:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1813:OpenedToWebPopup;
      ...
      private var var_1812:AvatarSearchResults;
      ...
      {
         this.var_2567 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_94 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1812 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_612.stop();
            this.var_612.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_612 = null;
         }
         ...
         if(this.var_1079)
         {
            this.var_1079.release(new IIDAvatarRenderManager());
            this.var_1079 = null;
         }
         if(this.var_949)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1813 = new OpenedToWebPopup(this);
         }
         this.var_1813.show(x,y);
      }
      ...
      public function askForAFriend(param1:int, param2:String) : Boolean
      {
         ...
         this.searchResults.method_8(param1);
         return true;
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_276,HabboWindowStyle.const_39,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1079.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "AssetLoaderEventBroker";
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1079 = param2 as IAvatarRenderManager;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_960,this.getText("friendlist.friends")));
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_336,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_94.addFriend(new Friend(_loc4_));
         }
         this.var_390 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_612)
         {
            this.var_612 = new Timer(120000);
            this.var_612.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_612.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_94.findCategory(FriendCategory.const_336);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_390.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_350));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_390.findTab(FriendListTab.const_94).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_390.findTab(FriendListTab.const_94);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1812.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_390.findTab(FriendListTab.const_94);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_751 || !this.var_359)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_751.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_359.vipLimit;
         }
         else if(this.var_751.hasUserRight("fuse_extended_buddylist"))
         {
