package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_394:int = 100;
      ...
      {
         return Math.ceil(this.var_200.length / const_394);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_817 * const_394;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_817 + 1) * const_394,this.var_200.length);
      }
