package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1663:String = "noconvinfo";
      
      private static const const_1662:String = "messageinput";
      ...
      private function prepare() : void
      {
         ...
         this.var_228 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1330.prepare(this.var_932);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_986,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1136,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_724,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_703,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_724,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_703,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1329 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1329.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1685 == -1 ? 0 : int(this.var_16.height - this.var_1685);
         var _loc4_:int = this.var_1684 == -1 ? 0 : int(this.var_16.width - this.var_1684);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_228.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1082,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_724,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_986,false);
         ...
         this.var_1685 = this.var_16.height;
         this.var_1684 = this.var_16.width;
