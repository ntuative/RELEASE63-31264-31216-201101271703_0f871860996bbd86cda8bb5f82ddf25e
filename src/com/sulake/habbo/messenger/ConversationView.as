package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_912:int = 100;
      
      private static const const_1262:int = 20;
      ...
      private var var_1699:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_128 = param1;
         this.var_1699 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_912 + const_1262)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1263;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_481 == null || _loc1_.id != this.var_481.id)
         {
            this.var_481 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_481.followingAllowed)
         {
            this.var_1699.enable();
         }
         else
         {
            this.var_1699.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_56.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_481.messages.length - const_912);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_481.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_481.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_764 || param3.type == Message.const_702 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_481.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_128.send(new FollowFriendMessageComposer(this.var_481.id));
      }
