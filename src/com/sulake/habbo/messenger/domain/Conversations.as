package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1099:int = 1;
       
      
      private var var_398:IConversationsDeps;
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(this._startIndex + this.var_398.getTabCount() <= _loc2_)
         {
            ++this._startIndex;
         }
      }
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_653,0,this.var_398.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         this.var_398.addMsgToView(_loc3_,param1);
         if(_loc2_ != this.var_125.length || _loc4_ != _loc3_.newMessageArrived)
         {
            this.var_398.refresh(false);
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         this.var_398.addMsgToView(_loc3_,_loc4_);
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = this.var_398.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_125.length - this.var_398.getTabCount());
      ...
      {
         return this.var_398.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
   }
}
