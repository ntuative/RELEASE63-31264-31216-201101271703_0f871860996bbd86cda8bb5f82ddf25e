package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      {
         return Math.floor(this.var_932.width / this.var_1167);
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_932.width % this.var_1167;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_164 ? this.var_128.conversations.findConversation(param2.id) : this.var_128.conversations.openConversations[_loc3_ + this.var_128.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
