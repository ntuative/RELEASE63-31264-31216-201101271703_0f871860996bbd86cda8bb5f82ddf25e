package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_353)
         {
            this.var_353.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_353.reset();
            this.var_353 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_52 == null)
         {
            this.var_52 = IWindowContainer(this._navigator.getXmlWindow(this.var_974));
         ...
         this.var_52.x = _loc2_.x + this.var_2350 + param1.width;
