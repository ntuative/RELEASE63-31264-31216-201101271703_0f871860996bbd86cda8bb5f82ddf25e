package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "AssetLoaderEventBroker" && false)
         {
