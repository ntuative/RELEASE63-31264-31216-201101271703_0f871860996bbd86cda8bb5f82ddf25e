package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_462:RoomPopupCtrl;
      
      private var var_521:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_462 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_521 = IScrollbarWindow(this.var_162.findChildByName("scroller"));
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_462.visible && this.var_2209)
            {
               return;
            }
            ...
            this.var_462.room = _loc4_;
            this.var_462.showPopup(param2);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2210 - _loc2_.stageX);
         this.var_2210 = _loc2_.stageX;
         this.var_2209 = _loc3_ > 2;
      }
   }
}
