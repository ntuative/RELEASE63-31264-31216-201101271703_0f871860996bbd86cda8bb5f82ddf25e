package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1204:int = 4;
      ...
      private var var_810:PopularTagsListCtrl;
      
      private var var_811:GuestRoomListCtrl;
      
      private var var_990:OfficialRoomListCtrl;
      ...
      private var var_989:Boolean = true;
      
      private var var_1243:int = 0;
      
      private var var_1244:IWindow;
      
      private var var_988:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_810 = new PopularTagsListCtrl(this._navigator);
         this.var_811 = new GuestRoomListCtrl(this._navigator);
         this.var_990 = new OfficialRoomListCtrl(this._navigator);
         this.var_442 = new Timer(300,1);
         this.var_442.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_442)
            {
               this.var_442.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_442.reset();
               this.var_442 = null;
            }
            if(this.var_810)
      ...
      private function prepare() : void
      {
         ...
         this.var_237 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_237)
         {
         ...
         this.var_199 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_181 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_228 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1244 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_988 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_988)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_988.procedure = this.onHotelView;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_861,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1591,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_162,["custom_content","list_content"],this.var_199.y,8);
         this.var_181.height = this.var_181.height + _loc1_ - this.var_181.y - this.var_228.height + this.var_2036;
         Util.moveChildrenToColumn(this.var_162,["list_content","custom_footer"],this.var_181.y,0);
         this.var_2036 = this.var_228.height;
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_199);
         if(Util.hasVisibleChildren(this.var_199))
         {
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_228);
      ...
      {
         this.refreshList(param1,param2,this.var_811,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_810,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_990,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_537 == const_881)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_181.blend - _loc2_));
            this.var_181.blend = _loc3_;
            this.var_199.blend = !!this.var_989 ? Number(_loc3_) : Number(1);
            this.var_228.blend = !!this.var_989 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_537 = const_568;
            }
         }
         else if(this.var_537 == const_568)
         {
            if(this.var_1243 % 10 == 1)
            {
               this.var_1244.visible = !this.var_1244.visible;
            }
            ++this.var_1243;
            if(!this._navigator.data.isLoading())
            {
               this.var_537 = const_882;
            }
         }
         else if(this.var_537 == const_882)
         {
            this.refresh();
            this.var_537 = const_1204;
         }
         else
         {
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.refreshScrollbar(this.var_811);
      }
      ...
      {
         this._navigator.refreshButton(this.var_988,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_988,"icon_hotelview_reactive",param1,null,0);
      }
