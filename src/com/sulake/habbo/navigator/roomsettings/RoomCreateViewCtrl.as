package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1029:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_559 = new Timer(100);
         this.var_559.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_40 = new Array();
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,104,"a"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,94,"b"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,36,"c"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,84,"d"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"e"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"f"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,416,"i"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,320,"j"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,448,"k"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,352,"l"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,384,"m"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_559)
         {
            this.var_559.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_559.reset();
            this.var_559 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1029.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1581 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1581 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_56 = IItemListWindow(this.var_162.findChildByName("item_list"));
         ...
         this.var_1030 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_162.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1030.goBackToInitialState();
         this.var_1030.input.textBackgroundColor = 4294967295;
         this.var_1029 = this.var_40[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_31,HabboWindowParam.const_61,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1030.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1030.getText();
         var _loc3_:String = "model_" + this.var_1029.name;
