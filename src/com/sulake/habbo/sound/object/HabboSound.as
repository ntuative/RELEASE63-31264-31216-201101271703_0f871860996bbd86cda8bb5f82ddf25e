package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1065:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1065.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_514 = 1;
         this.var_1300 = false;
      }
      ...
      {
         this.var_1300 = false;
         this._soundChannel = this.var_1065.play(0);
      ...
      {
         return this.var_1065.length;
      }
      
      public function get ready() : Boolean
      {
         return !this.var_1065.isBuffering;
      }
