package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1970:String = "type_sound_machine";
      
      private const const_1677:String = "type_jukebox";
      
      private var var_534:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_625,this.onSongFinishedPlayingEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_675,this.onSoundMachinePlayEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_710,this.onSoundMachineStopEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_692,this.onJukeboxInitEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_512,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_625,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_87)
            {
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_675,this.onSoundMachinePlayEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_710,this.onSoundMachineStopEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_692,this.onJukeboxInitEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_512,this.onDisposeEvent);
               this.var_87 = null;
            }
            if(this.var_411)
            {
      ...
      {
         this.startPlaying(this.const_1970);
      }
      ...
      {
         this.startPlaying(this.const_1677);
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_411[this.var_292] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_411.getValue(this.var_292) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_292 = param1;
         var _loc2_:IHabboSound = this.var_411.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_534.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_534.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_292)
         {
            _loc6_ = this.var_411[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1787 == this.const_1677)
         {
            this.var_78.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_608.indexOf(param1) == -1)
         {
            this.var_608.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_608 = this.var_608.splice(this.var_608.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_411[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_534.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_411.add(_loc3_.id,_loc7_);
            }
