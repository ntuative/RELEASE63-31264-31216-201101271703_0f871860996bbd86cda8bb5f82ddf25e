package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_625:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1013,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_947.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1384:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1472:
                  _loc3_ = "sound_console_new_message";
                  break;
               case HabboSoundTypesEnum.const_1618:
                  _loc3_ = "sound_message_sent";
                  break;
               case HabboSoundTypesEnum.const_1033:
                  _loc3_ = "sound_catalogue_pixels";
                  break;
               case HabboSoundTypesEnum.const_946:
            ...
            this.var_947.add(param1,_loc2_);
         }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_771.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_771,events);
      ...
      {
         if(this.var_170 == null || this._connection == null || this._roomEngine == null || this.var_625 != null)
         {
            return;
         }
         this.var_625 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         this.var_771.add(_loc3_,_loc6_);
         if(this.var_626.length == 0 && this.var_772 != -1)
         {
            this.var_948.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1013,this.var_772));
            this.var_772 = -1;
            this.var_948 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_625.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1589,this.var_772));
         this.var_772 = -1;
         this.var_948 = null;
      }
      ...
      {
         this.var_514 = param1;
         this.var_625.updateVolume(this.var_514);
