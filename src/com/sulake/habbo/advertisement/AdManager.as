package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1157:BitmapData = null;
      
      private var var_1158:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2557 = this._config.getKey("interstitial.enabled","false") == "AssetLoaderEventBroker";
         this.var_2558 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2556 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1805 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_218 != null && this.var_218.running)
         {
            this.var_218.reset();
            return false;
         }
         if(this.var_1156 == 0)
         {
            this.var_1156 = getTimer();
            return false;
         }
         if(this.var_1805 > 0 && this.var_1804 >= this.var_1805)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1156;
         if(_loc1_ > this.var_2558)
         {
            ++this.var_1804;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1403 = _loc2_.imageUrl;
         this.var_2555 = _loc2_.clickUrl;
         this.var_1156 = getTimer();
         if(this.var_1403 != "")
         {
            _loc3_ = this.var_1403;
            ...
            {
               this.var_218 = new Timer(this.var_2556,1);
               this.var_218.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_218.running)
            {
               this.var_218.reset();
            }
            this.var_218.start();
            _loc4_ = new URLRequest(this.var_1403);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_500,0,0,param1.bitmapData,this.var_2555));
            this.var_1156 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_432));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1404 = _loc2_.imageUrl;
         this.var_1806 = _loc2_.clickUrl;
         if(this.var_1404 != "" && this.var_1806 != "")
         {
            _loc3_ = this.var_1404;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1404);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_412,0,0,_loc4_,this.var_1806,this.var_1157,this.var_1158));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1157 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1158 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
