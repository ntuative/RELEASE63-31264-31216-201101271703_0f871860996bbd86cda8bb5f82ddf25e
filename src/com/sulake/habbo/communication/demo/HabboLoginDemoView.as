package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_141.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_145,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1641,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_141.habboConfiguration.getKey("use.sso","false") == "AssetLoaderEventBroker")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1641,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_120.removeEventListener(SSOTicket.const_343,this.onParsedTicketSuccess);
            this.var_120.removeEventListener(SSOTicket.const_286,this.onParsedTicketFailure);
            this.var_120 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_120 = new SSOTicket(this.var_141.assets,_loc3_,_loc2_,param1);
         this.var_120.addEventListener(SSOTicket.const_343,this.onParsedTicketSuccess);
         this.var_120.addEventListener(SSOTicket.const_286,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_141.shockwaveClientUrl = this.var_120.shockwaveClientUrl;
         this.var_141.ssoTicket = this.var_120.ticket;
         this.var_120.removeEventListener(SSOTicket.const_343,this.onParsedTicketSuccess);
         this.var_120.removeEventListener(SSOTicket.const_286,this.onParsedTicketFailure);
         this.var_120 = null;
         dispatchEvent(new Event(const_484));
