package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2003:PseudoRandom;
      ...
      private var var_196:HabboHotelView;
      
      private var var_1234:String = "";
      
      private const const_1641:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_530 = param1;
            this.var_47.initConnection(HabboConnectionType.const_265);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_96,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_47 && this.var_117 && this.var_17 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_196 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_196.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_117.getKey("use.sso.ticket") == "1";
         this.var_530 = this.var_117.getKey("sso.ticket",null);
         this.var_1488 = this.var_117.getKey("flash.client.url","");
         this.var_2001 = this.var_117.getKey("external.variables.txt","");
         if(this.var_196 == null)
         {
            this.var_196 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_47.mode = HabboConnectionType.const_118;
            if(this.var_530)
            {
               this.var_47.initConnection(HabboConnectionType.const_265);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_47.mode = HabboConnectionType.const_976;
            }
         }
         this.var_47.initConnection(HabboConnectionType.const_265);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2003 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_47.mode)
         {
            case HabboConnectionType.const_118:
               _loc6_ = "";
               ...
               this.var_196.loadBannerImage(_loc7_ + "?token=" + this.var_1234,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_976:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1527:
               this.var_800 = this.generateRandomHexString(30);
               this.var_440 = new DiffieHellman(new BigInteger(this.var_117.getKey("connection.development.prime"),16),new BigInteger(this.var_117.getKey("connection.development.generator"),16));
               this.var_440.init(this.var_800);
               _loc8_ = this.var_440.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_440.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_440.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2003);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1488,this.var_2001));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1641,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2002)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1234);
         ...
         this.var_440 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_440.init(_loc14_);
            _loc15_ = this.var_440.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_800 = _loc14_;
            }
