package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1747 = _loc2_;
            this.var_2449 = param1.extra;
            this.var_1116 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1116 > 0 && param1 >= this.var_1116)
         {
            this.var_1116 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1747,String(this.var_1747),this.var_2449);
