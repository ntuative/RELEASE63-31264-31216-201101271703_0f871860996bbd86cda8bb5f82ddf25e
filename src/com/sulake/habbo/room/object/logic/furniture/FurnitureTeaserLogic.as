package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_1969:String = "TYPE_INJECTED";
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc4_ == this.const_1969)
         {
            if(param1.type == MouseEvent.MOUSE_UP)
            {
               if(eventDispatcher != null)
               {
                  ...
                  _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_143,_loc5_,_loc6_);
         ...
         else if(param1.type == MouseEvent.DOUBLE_CLICK)
         {
            if(eventDispatcher != null)
            {
               _loc5_ = object.getId();
               _loc6_ = object.getType();
               _loc7_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_539,_loc5_,_loc6_);
               eventDispatcher.dispatchEvent(_loc7_);
            }
         }
