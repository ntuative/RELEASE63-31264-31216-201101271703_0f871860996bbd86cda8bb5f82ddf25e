package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      private var var_1327:Vector3d;
      
      private var var_2779:Vector3d;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null)
         {
            if(param1.loc != null)
            {
               ...
               this.var_2301 = this._lastUpdateTime;
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = param1 - this.var_2301;
            if(_loc2_ > this.var_986)
            {
               _loc2_ = this.var_986;
            }
            _loc3_ = Vector3d.product(this.var_1327,_loc2_ / Number(this.var_986));
