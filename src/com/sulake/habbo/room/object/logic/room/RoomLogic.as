package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_953,param1.toString(),true);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1033)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1592;
            if(_loc2_ - this.var_1033 >= this.var_1590)
            {
               _loc3_ = this.var_1034;
               _loc4_ = this.var_1589;
               this.var_1033 = 0;
            }
            else
            {
               _loc7_ = this.var_1283 >> 16 & 255;
               _loc8_ = this.var_1283 >> 8 & 255;
               _loc9_ = this.var_1283 & 255;
               _loc10_ = this.var_1034 >> 16 & 255;
               _loc11_ = this.var_1034 >> 8 & 255;
               _loc12_ = this.var_1034 & 255;
               _loc13_ = (_loc2_ - this.var_1033) / this.var_1590;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1591 + (this.var_1589 - this.var_1591) * _loc13_;
               this._color = _loc3_;
               this.var_1592 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_615:
               param2.setString(RoomObjectVariableEnum.const_844,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_720:
               param2.setString(RoomObjectVariableEnum.const_659,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_594:
               param2.setString(RoomObjectVariableEnum.const_803,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_425:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_235)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_694:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1077,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1096:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1085:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_969,int(param1.bgOnly));
         this.var_1283 = this._color;
         this.var_1591 = this.var_1592;
         this.var_1034 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_463,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1406,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1541,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1550,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_463,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_166)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_151 || _loc13_ == RoomPlaneData.const_297)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
