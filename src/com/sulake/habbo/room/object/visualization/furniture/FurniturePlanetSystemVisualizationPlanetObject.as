package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1331:Number = 30;
      ...
      {
         var _loc4_:* = null;
         this.var_1188 += this.var_2671 / const_1331;
      ...
      {
         var _loc3_:Number = this.var_1263 * Math.cos(this.var_1188 + this.var_1889);
         var _loc4_:Number = this.var_1263 * Math.sin(this.var_1188 + this.var_1889);
