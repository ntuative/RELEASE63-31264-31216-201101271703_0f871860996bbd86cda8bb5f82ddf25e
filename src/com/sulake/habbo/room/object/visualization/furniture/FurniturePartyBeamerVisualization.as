package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_401:int = 2;
      
      private static const const_944:int = 15;
      
      private static const const_943:int = 31;
      
      private static const const_1330:int = 2;
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(_loc2_ != null)
         {
            this.var_770[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_770[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_770.length == 2)
            {
               return this.var_770[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_770.length == 2)
            {
               return this.var_770[param3 - 2].y;
            }
         }
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc4_:int = this.var_1185[param2];
         var _loc5_:int = this.var_1184[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1185.push(1);
         this.var_1185.push(-1);
         this.var_1184 = new Array();
         this.var_1184.push(const_1330);
         this.var_1184.push(ANIM_SPEED_SLOW);
