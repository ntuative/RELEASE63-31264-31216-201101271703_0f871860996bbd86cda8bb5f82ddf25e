package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1633:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2705:Number = NaN;
      
      protected var var_2704:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1201:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1579 != spriteCount)
         {
            createSprites(this.var_1579);
         }
         var _loc4_:Boolean = false;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_427 != _loc3_.getUpdateID() || param1 != var_222 || param2 != this.var_2705)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_223 != _loc3_.getUpdateID())
         {
            this.var_2704 = _loc3_.getNumber(RoomObjectVariableEnum.const_239);
            ...
            this.var_1201 = _loc3_.getString(RoomObjectVariableEnum.const_370);
            if(this.var_1201 == null || this.var_1201.indexOf("http") != 0)
            {
               this.var_1201 = null;
            }
            var_223 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      {
         if(this.var_2157 != param2 || this.var_2156 != param1)
         {
            this.var_837 = [];
            this.var_838 = [];
            this.var_670 = [];
            ...
            this.var_1579 = this._data.getLayerCount(param1) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_974.length)
         {
            return "";
         }
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param2 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_974[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_671[param3] != null && !this.var_1580)
         {
      ...
      {
         if(this.var_677[param2] != null)
         {
            return this.var_677[param2];
         }
         if(this._data == null)
         {
