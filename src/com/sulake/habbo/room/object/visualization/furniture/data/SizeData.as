package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_365:int = 1000;
      ...
      private var var_1041:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_682 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_682,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_682);
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1284 / 2) % 360 / this.var_1284;
         ...
         {
            _loc6_ = int(this.var_236.getKey(_loc5_)) * this.var_1284;
