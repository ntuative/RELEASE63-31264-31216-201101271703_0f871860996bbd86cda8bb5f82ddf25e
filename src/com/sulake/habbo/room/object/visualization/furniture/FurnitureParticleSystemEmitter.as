package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1549:String = "cone";
      
      public static const const_1408:String = "plane";
      
      public static const const_1441:String = "sphere";
      ...
      private var var_839:Number = 0.1;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_326)
         {
            _loc1_.dispose();
         }
         this.var_326 = null;
      ...
      public function reset() : void
      {
         ...
         this.var_840 = 0;
         this.var_812 = false;
         this.init(0,0,0,this._direction,this.var_2160,this.var_839,this.var_2163,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1032.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_812 = true;
         if(this.var_840 < this.var_1282)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2162)
         {
            switch(this.var_2161)
            {
               case const_1549:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_839,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1032.length);
         return this.var_1032[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_840 < this.var_1282)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_840 < this.var_1282)
         {
            ...
            this.y = (2 - this.var_235) * this.y - (1 - this.var_235) * this.lastY + this.var_1586 * this.var_839 * this.var_839;
         ...
         for each(_loc2_ in this.var_326)
         {
            ...
            _loc2_.y = (2 - this.var_235) * _loc2_.y - (1 - this.var_235) * _loc2_.lastY + this.var_1586 * this.var_839 * this.var_839;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_326.splice(this.var_326.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
