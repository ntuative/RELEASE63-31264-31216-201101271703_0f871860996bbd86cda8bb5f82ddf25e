package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1286:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1115)
            {
      ...
      {
         if(this.var_2448 == param1 && this.var_2447 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1286)
            {
               this.var_1744 = _loc2_;
               this.var_2448 = param1;
               this.var_2447 = _direction;
               return this.var_1744;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_490 == 0 || this.var_588 == 0)
         {
            ...
            this.var_490 = _loc2_.getNumber(RoomObjectVariableEnum.const_280);
            this.var_588 = _loc2_.getNumber(RoomObjectVariableEnum.const_375);
         }
         this.var_403 = [];
         this.var_589 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_490 * 2 + this.var_588 * 2)
         {
            this.var_403.push(false);
            this.var_589.push(ShoreMaskCreatorUtility.const_71);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_66,getSize(param3),this.var_403,this.var_589,assetCollection);
      }
