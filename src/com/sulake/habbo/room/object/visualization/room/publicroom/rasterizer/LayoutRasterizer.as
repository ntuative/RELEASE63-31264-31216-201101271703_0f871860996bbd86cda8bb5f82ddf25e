package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1268:IGraphicAssetCollection;
      
      private var var_1653:XMLList;
      ...
      private var var_950:Boolean = true;
      ...
      private var var_1186:Point = null;
      
      private var var_1442:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_951)
         {
            this.var_951 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1442 = this.var_40.getValue(this.var_951);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2665 = new Vector3d(-0.5,0.5,0);
         this.var_950 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2665);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1186.x = _loc3_.x;
         this.var_1186.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_40.getValue(this.var_951);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1886 = RoomObjectVariableEnum.const_1175;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1886 = RoomObjectVariableEnum.const_1140;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1187 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1187 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_40.getValue(this.var_951);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2666 && param3 == this.var_2664)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1187 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1187 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1886);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1442.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_1268.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1186.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1186.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_418.indexOf(_loc10_) >= 0 && this.var_950)
            {
               param1 = this.var_418.indexOf(_loc10_);
               if(this.var_627[param1] != "")
               {
                  _loc9_ = this.var_1268.getAsset(this.var_627[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
      ...
      {
         this.var_950 = true;
         var _loc3_:int = this.var_418.indexOf(param1);
         if(_loc3_ < 0)
         {
