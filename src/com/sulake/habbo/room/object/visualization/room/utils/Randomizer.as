package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1791:int = 1;
      
      public static const const_1836:int = 16777216;
      ...
      private var var_1565:int = 16777216;
      
      private var var_2735:int = 69069;
      
      private var var_2734:int = 5;
      ...
      {
         var _loc1_:int = this.var_2735 * this.var_1566 + this.var_2734;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1565;
         this.var_1566 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1565 * param2);
      }
   }
}
