package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1481:int = 16777215;
      
      public static const const_1485:int = 13421772;
      
      private static const const_892:int = 16777215;
      
      private static const const_890:int = 13421772;
      
      private static const const_891:int = 10066329;
      
      private static const const_889:int = 10066329;
      
      public static const const_1613:int = 16777215;
      
      public static const const_1437:int = 13421772;
      ...
      private var var_683:Rectangle = null;
      ...
      private var var_2175:int = 255;
      
      private var var_2176:int = 255;
      
      private var var_2173:int = 255;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_683 = super.boundingRectangle;
         }
         return new Rectangle(this.var_683.x,this.var_683.y,this.var_683.width,this.var_683.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_953);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1051);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_297)
            {
               ...
               if(this._data != null)
               {
                  _loc13_.rasterizer = this._data.method_10;
               }
               _loc5_ += _loc9_.length;
            }
            else if(_loc12_ == RoomPlaneData.const_1509)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_114,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_560[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_328[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_97)
               {
                  if(this.var_1599)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2173 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2176 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2175 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1490)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1356 || _loc3_.y != this.var_2174 || _loc3_.z != this.var_2170 || param1.scale != this.var_2172))
            {
               this.var_1356 = _loc3_.x;
               this.var_2174 = _loc3_.y;
               this.var_2170 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_223 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1077);
            if(_loc3_ != this.var_2169)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2169 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_678));
            if(_loc4_ != this.var_1042)
            {
               this.var_1042 = _loc4_;
               this.var_2173 = this.var_1042 & 255;
               this.var_2176 = this.var_1042 >> 8 & 255;
               this.var_2175 = this.var_1042 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_969));
            if(_loc5_ != this.var_1599)
            {
               this.var_1599 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_223 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_659);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_844);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_803);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_604));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_769));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_328;
         if(this.var_328.length == 0)
         {
            _loc6_ = this.var_123;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_328.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_328.push(_loc12_);
                        this.var_560.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1600;
      }
         ...
         while(_loc8_ < this.var_457.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_123.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.const_97)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.const_97 && _loc12_ == RoomPlaneBitmapMaskData.const_235)
                              {
