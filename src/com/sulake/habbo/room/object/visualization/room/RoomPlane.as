package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_858:IPlaneRasterizer = null;
      
      private var var_734:PlaneMaskManager = null;
      ...
      private var var_388:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2234 = param9;
         this.var_2233 = param10;
         this.var_2235 = param11;
         this.var_2238 = param12;
         this.var_856 = param6;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_186 != null)
         {
            ...
            {
               _loc2_ = this.var_186.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      private function method_5(param1:String, param2:PlaneBitmapData) : Boolean
      {
         var _loc3_:PlaneBitmapData = this.var_186.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_186 != null)
         {
            ...
            {
               _loc3_ = this.var_186.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_858.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_388;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_186.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_700 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_336))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_287.length * param1.scale;
            _loc6_ = this.var_286.length * param1.scale;
            ...
            if(this.var_858 != null)
            {
               _loc3_ = this.var_858.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1654,this.var_2234,this.var_2233,this.var_2235,this.var_2238,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1490 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1301.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1301[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1066);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_144.z - originZ,this.var_107.z - originZ,this.var_82.z - originZ,this.var_106.z - originZ);
            ...
            this.var_1490 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2237);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_114 || this._type == const_97)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_114 || this._type == const_97))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_241.length == this.var_857.length)
         {
         ...
         if(this.var_337.length > this.var_1302.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_856 || this.var_241.length == 0 && this.var_337.length == 0 && !this.var_336 || this.var_734 == null)
         {
            return;
         }
         ...
         if(this.var_336)
         {
            ...
            while(_loc5_ < this.var_241.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc3_.leftSideLoc / this.var_287.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc3_.rightSideLoc / this.var_286.length;
                  _loc12_ = _loc3_.type;
                  this.var_734.updateMask(this.var_66,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_337.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc4_.leftSideLoc / this.var_287.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc4_.rightSideLoc / this.var_286.length;
                  _loc13_ = this.var_66.width * _loc4_.leftSideLength / this.var_287.length;
                  _loc14_ = this.var_66.height * _loc4_.rightSideLength / this.var_286.length;
                  this.var_66.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1302.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_336 = false;
