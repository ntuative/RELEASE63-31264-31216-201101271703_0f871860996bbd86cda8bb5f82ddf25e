package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1308:String = "_alert_button_list";
      
      private static const const_641:String = "_alert_button_ok";
      
      private static const const_927:String = "_alert_button_cancel";
      
      private static const const_926:String = "_alert_button_custom";
      
      private static const const_1545:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = this._window.findChildByName(const_1308) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_641);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  ...
                  {
                     this.var_266(this,new WindowEvent(WindowEvent.const_178,null,null));
                  }
                  break;
               case "header_button_close":
                  if(this.var_266 != null)
                  {
                     this.var_266(this,new WindowEvent(WindowEvent.const_860,null,null));
                  }
            }
         }
      }
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_641:
                  _loc2_ = this._window.findChildByName(const_641) as IInteractiveWindow;
                  break;
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_1562;
         }
      }
