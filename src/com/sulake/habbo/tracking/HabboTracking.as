package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_921:uint = 11;
      ...
      private var var_598:FramerateTracker = null;
      
      private var var_253:LatencyTracker = null;
      
      private var var_596:LagWarningLogger = null;
      
      private var var_597:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_598 = new FramerateTracker();
         this.var_253 = new LatencyTracker();
         this.var_596 = new LagWarningLogger();
         this.var_597 = new ToolbarClickTracker(this);
         this.var_1379 = new Array(const_921);
         var _loc4_:int = 0;
         while(_loc4_ < const_921)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1491,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1447,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_864,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1143,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_190)
            {
               ...
               {
                  Component(this.var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_190).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_190).events.removeEventListener(HabboFriendListTrackingEvent.const_350,this.onFriendlistTrackingEvent);
               }
               this.var_190.release(new IIDHabboFriendList());
               this.var_190 = null;
            }
            if(this.var_163)
            {
            ...
            if(this.var_169)
            {
               ...
               {
                  this.var_169.events.removeEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_170)
         {
            if(this.var_253 != null)
            {
               this.var_253.configuration = this.var_170;
            }
            if(this.var_254 != null)
            {
            ...
            this.trackLoginStep(HabboLoginTrackingStep.const_1531);
            if(this.var_170)
            {
               if(this.var_596 != null)
               {
                  this.var_596.configure(this.var_170);
               }
               if(this.var_598 != null)
               {
                  this.var_598.configure(this.var_170);
               }
               if(this.var_597 != null)
               {
                  this.var_597.configure(this.var_170);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_852,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_532,this.onHotelViewEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_852)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1426);
         }
         else if(param1.type == HabboHotelViewEvent.const_532)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1587);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1375);
               break;
            case HabboCommunicationEvent.const_865:
               this.trackLoginStep(HabboLoginTrackingStep.const_1502,String(this._communication.port));
               break;
      ...
      {
         this.var_190 = param2 as IHabboFriendList;
         Component(this.var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_190).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_190).events.addEventListener(HabboFriendListTrackingEvent.const_350,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_350:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2490)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1377);
            this.var_2490 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1143,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_864,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_314,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_289 = param2 as IAdManager;
         this.var_289.events.addEventListener(AdEvent.const_412,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_169 = param2 as IHabboToolbar;
         this.var_169.events.addEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_597)
         {
            this.var_597.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1758;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1758);
         }
         if(this.var_496 > -1 && _loc2_ - this.var_496 > 15000)
         {
            ++this.var_1759;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1759);
         }
         this.var_496 = _loc2_;
         if(this.var_254 != null)
         {
            this.var_254.update(param1,this.var_496);
         }
         if(this.var_253 != null)
         {
            this.var_253.update(param1,this.var_496);
         }
         if(this.var_598 != null)
         {
            this.var_598.trackUpdate(param1,this,this.var_496);
         }
         if(this.var_596 != null)
         {
            this.var_596.update(this.var_496);
         }
      }
   }
}
