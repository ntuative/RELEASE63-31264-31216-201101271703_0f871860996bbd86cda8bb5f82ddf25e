package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1734 = int(this.var_170.getKey("latencytest.interval"));
         this.var_1737 = int(this.var_170.getKey("latencytest.report.index"));
         this.var_2440 = int(this.var_170.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1736 > this.var_1734)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_586.add(this.var_1360,this.var_1736);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1360));
         ++this.var_1360;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_586 == null || this.var_212 == null)
         {
            return;
         }
         ...
         if(this.var_212.length == this.var_1737 && this.var_1737 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1735) > this.var_2440 || this.var_1735 == 0)
            {
