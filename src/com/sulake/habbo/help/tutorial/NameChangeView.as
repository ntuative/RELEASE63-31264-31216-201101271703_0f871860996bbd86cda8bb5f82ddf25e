package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_699)
         {
            this.var_699 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_699)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_698)
         {
            this.var_698 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_698)
            {
               return;
            }
