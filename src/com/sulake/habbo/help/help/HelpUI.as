package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1683:int = 0;
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201101271658));
         this.var_169 = param5;
         this.var_100 = new Map();
         this.var_100.add(HabboHelpViewEnum.const_1604,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_190,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_534,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_310,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_241,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_632,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_347,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_718,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_220,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_100.add(HabboHelpViewEnum.const_1156,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_100.add(HabboHelpViewEnum.const_1105,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_100.add(HabboHelpViewEnum.const_854,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_100.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_100.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_506.length == 0 || param1 != this.var_358)
            {
               this.var_506.push(this.var_358);
            }
         }
         this.var_358 = param1;
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_100.getValue(HabboHelpViewEnum.const_190) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_424));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_100.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_100.getValue(this.var_358);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1809 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1808;
         this._window.width = _loc1_.width + this.var_1809;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_358 == HabboHelpViewEnum.const_190)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_357.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_358 == HabboHelpViewEnum.const_190 || this.var_506.length == 0)
         {
            return;
         }
         if(this.var_357 == null)
         {
            ...
            this.var_357 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_357.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_357.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_357 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_357 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_357 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
