package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_706:FaqCategory;
      
      private var var_705:FaqCategory;
      ...
      {
         super();
         this.var_707 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_706 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_705 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_146 != null)
         {
            ...
            {
               _loc2_ = this.var_146.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_146.getValue(param1);
      ...
      {
         var _loc4_:* = null;
         if(this.var_707.hasItem(param1))
         {
            this.var_707.getItem(param1).answerText = param2;
         }
         if(this.var_706.hasItem(param1))
         {
            this.var_706.getItem(param1).answerText = param2;
         }
         if(this.var_705.hasItem(param1))
         {
            this.var_705.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_146.length)
         {
            _loc4_ = this.var_146.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_707.hasItem(param1))
         {
            return this.var_707.getItem(param1);
         }
         if(this.var_706.hasItem(param1))
         {
            return this.var_706.getItem(param1);
         }
         if(this.var_705.hasItem(param1))
         {
            return this.var_705.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_146.length)
         {
            _loc3_ = this.var_146.getWithIndex(_loc2_);
